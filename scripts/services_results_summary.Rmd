...
serv_smp<-left_join(serv_smp,def_serv, by="CSIScontractID")
...
any(def_serv$Action.Obligation<0)
money[def_serv$Action.Obligation<0]<-0
sum(def_serv$Action.Obligation[def_serv$Action.Obligation<0])

#Overall
length(money[!complete])/length(money)
sum(money[!complete],na.rm=TRUE)/sum(money,na.rm=TRUE)

summary(def_serv[def_serv$Crisis=="OCO",])

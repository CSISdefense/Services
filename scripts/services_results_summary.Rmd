...
def_serv<-read_and_join_experiment( def_serv,
                             ...
                             add_var=c("office_entity_paircount_7year","office_entity_numberofactions_7year",
                                       "office_entity_obligatedamount_7year"),
                             new_var_checked=FALSE)

summary(def_serv$office_entity_numberofactions_7year)
...
def_serv$office_entity_numberofactions_7year[is.na(def_serv$office_entity_numberofactions_7year)&
                                         !is.na(def_serv$EntityID)]<-0
...
statsummary_continuous(ratio_category, def_serv)
statsummary_continuous(avg_category, def_serv)
statsummary_continuous(obl_category, def_serv)
...
sum(def_serv$Action.Obligation[is.na(def_serv$EffComp)],na.rm=TRUE)/sum(def_serv$Action.Obligation,na.rm=TRUE)
...
!is.na(def_serv$office_psc_obligatedamount_7year)&
!is.na(def_serv$office_entity_paircount_7year)&
!is.na(def_serv$office_entity_numberofactions_7year)&
#Controls
...
!is.na(def_serv$office_entity_obligatedamount_7year)

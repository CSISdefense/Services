...
load(file="../data/semi_clean/defense_contract_complete.RData")

def<-def[def$MinOfSignedDate>=as.Date("2008-01-01") & def$MinOfSignedDate<=as.Date("2015-12-31"),]
def_serv<-def[def$PSR %in% c("Services","R&D"),]
rm(def)    
...
summary(factor(def_serv$PricingFee))
def_serv$PricingUCA<-as.character(def_serv$PricingFee)
def_serv$PricingUCA[is.na(def_serv$UCA)]<-NA
summary(factor(def_serv$PricingUCA))
def_serv$PricingUCA[def_serv$UCA=="UCA"]<-"UCA"
def_serv$PricingUCA<-factor(def_serv$PricingUCA)
summary(def_serv$PricingUCA)
def_serv$Comp1or5<-def_serv$CompOffr
levels(def_serv$Comp1or5)<-
      list("No Competition"="No Competition",
           "1 offer"="1 offer",
           "2-4 offers"=c("2 offers","3-4 offers"),
           "5+ offers"="5+ offers")
summary(def_serv$Comp1or5)
...
summary(def_serv$office_numberofactions_1year)
summary(def_serv$office_obligatedamount_7year)
summary(def_serv$office_obligatedamount_1year)
summary(def_serv$office_PBSCobligated_1year)


def_serv$office_numberofactions_1year[is.na(def_serv$office_numberofactions_1year)]<-0
def_serv$office_obligatedamount_7year[is.na(def_serv$office_obligatedamount_7year) | 
                                        def_serv$office_obligatedamount_7year<0]<-0
def_serv$office_obligatedamount_1year[is.na(def_serv$office_obligatedamount_1year) | 
                                        def_serv$office_obligatedamount_1year<0]<-0
def_serv$office_PBSCobligated_1year[is.na(def_serv$office_PBSCobligated_1year)|
                                      def_serv$office_PBSCobligated_1year<0]<-0
def_serv$pPBSC<-def_serv$office_PBSCobligated_1year/def_serv$office_obligatedamount_1year
def_serv$pPBSC[def_serv$office_obligatedamount_1year==0]<-0
def_serv$pPBSC[def_serv$pPBSC>1]<-1
summary(def_serv$pPBSC)

def_serv$office_numberofactions_1year[is.na(def_serv$ContractingOfficeCode)]<-NA
def_serv$office_obligatedamount_7year[is.na(def_serv$ContractingOfficeCode)]<-NA
def_serv$office_obligatedamount_1year[is.na(def_serv$ContractingOfficeCode)]<-NA
def_serv$office_PBSCobligated_1year[is.na(def_serv$ContractingOfficeCode)]<-NA
def_serv$pPBSC[is.na(def_serv$ContractingOfficeCode)]<-NA
...
def_serv<-read_and_join_experiment( def_serv,
                             ...
                             new_var_checked=FALSE)
summary(def_serv$office_psc_obligatedamount_7year)
def_serv$office_psc_obligatedamount_7year[is.na(def_serv$office_psc_obligatedamount_7year)|
                                            def_serv$office_psc_obligatedamount_7year<0]<-0


def_serv$pOffPSC<-def_serv$office_psc_obligatedamount_7year/def_serv$office_obligatedamount_7year
def_serv$pOffPSC[def_serv$office_obligatedamount_7year==0]<-0
def_serv$pOffPSC[def_serv$pOffPSC>1]<-1
summary(def_serv$pOffPSC)
def_serv$office_psc_obligatedamount_7year[is.na(def_serv$ContractingOfficeCode) |
                                            is.na(def_serv$ProductOrServiceCode)]<-NA
def_serv$pOffPSC[is.na(def_serv$ContractingOfficeCode) |
                                            is.na(def_serv$ProductOrServiceCode)]<-NA
...
def_serv<-read_and_join_experiment_experiment( def_serv,
...
summary(def_serv$EntityID)
summary(def_serv$office_entity_numberofactions_1year)
summary(def_serv$office_entity_paircount_7year)
summary(def_serv$office_entity_obligatedamount_7year)
def_serv$pMarket<-def_serv$office_entity_obligatedamount_7year/def_serv$office_obligatedamount_7year
def_serv$pMarket[def_serv$office_obligatedamount_7year==0 & !is.na(def_serv$EntityID)]<-0
def_serv$pMarket[def_serv$pMarket>1]<-1
summary(def_serv$pMarket)

def_serv$office_entity_numberofactions_1year[is.na(def_serv$office_entity_numberofactions_1year)&
                                         !is.na(def_serv$EntityID)&!is.na(def_serv$ContractingOfficeCode)]<-0
def_serv$office_entity_paircount_7year[is.na(def_serv$office_entity_paircount_7year)&
                                         !is.na(def_serv$EntityID)&!is.na(def_serv$ContractingOfficeCode)]<-0

def_serv$office_entity_obligatedamount_7year[(is.na(def_serv$office_entity_obligatedamount_7year)|
                                            def_serv$office_entity_obligatedamount_7year<0)&
                                         !is.na(def_serv$EntityID)&!is.na(def_serv$ContractingOfficeCode)]<-0



load("..\\data\\semi_clean\\fed_transformed.rdata")
...
#About 24k inexplicably missing
...
summary(factor(def_serv$AnyUnmodifiedUnexercisedOptionsWhy))
summary(def_serv$UnmodifiedBaseandExercisedOptionsValue)


summary(def_serv$Crisis)
def_serv$OCO_GF<-def_serv$Crisis
levels(def_serv$OCO_GF)<-
      list("GF"=c("Other","ARRA","Dis"),
           "OCOC"="OCO")
summary(def_serv$OCO_GF)
...
summary(def_serv$CFTE_Rate_1year)
...
sum(def_serv$Action.Obligation[def_serv$b_Term==1],na.rm=TRUE)/sum(def_serv$Action.Obligation,na.rm=TRUE)`
...
sum(def_serv$Action.Obligation[def_serv$b_CBre==1],na.rm=TRUE)/sum(def_serv$Action.Obligation,na.rm=TRUE)
...
statsummary_continuous(c("OptGrowth"), def_serv)
```
...
sum(def_serv$Action.Obligation[def_serv$EffComp=="No Comp."],na.rm=TRUE)/sum(def_serv$Action.Obligation,na.rm=TRUE)
sum(def_serv$Action.Obligation[def_serv$EffComp=="1 Offer"],na.rm=TRUE)/sum(def_serv$Action.Obligation,na.rm=TRUE)
sum(def_serv$Action.Obligation[def_serv$EffComp=="2+ Offers"],na.rm=TRUE)/sum(def_serv$Action.Obligation,na.rm=TRUE)`
)
...
sum(def_serv$Action.Obligation[def_serv$CompOffr=="No Competition"],na.rm=TRUE)/sum(def_serv$Action.Obligation,na.rm=TRUE)
sum(def_serv$Action.Obligation[def_serv$CompOffr=="1 offer"],na.rm=TRUE)/sum(def_serv$Action.Obligation,na.rm=TRUE)
sum(def_serv$Action.Obligation[def_serv$CompOffr=="2 offers"],na.rm=TRUE)/sum(def_serv$Action.Obligation,na.rm=TRUE)
sum(def_serv$Action.Obligation[def_serv$CompOffr=="3-4 offers"],na.rm=TRUE)/sum(def_serv$Action.Obligation,na.rm=TRUE)
sum(def_serv$Action.Obligation[def_serv$CompOffr=="5+ offers"],na.rm=TRUE)/sum(def_serv$Action.Obligation,na.rm=TRUE)
...
summary(def_serv$l_def6_HHI_lag1);
centered_description(def_serv$def6_HHI_lag1,"HHI score")
centered_log_description(def_serv$l_def6_HHI_lag1,"HHI score")
...
cl_US6_avg_sal_lag1
cl_US6_avg_sal_lag1
centered_log_description(def_serv$l_US6_avg_sal_lag1,"dollars")
NA_stats(def_serv,"cl_US6_avg_sal_lag1")
...
complex_category <- c("US6_avg_sal_lag1")
capacity_category <- c("pPBSC", "pOffPSC")
pair_category <- c("pMarket","office_entity_numberofactions_1year")
...
statsummary_continuous(pair_category, def_serv,log=FALSE)
...
* cl_Ceil is the natural log of the initial contract cost ceiling, in then-year dollars. `r centered_log_description(def_serv$UnmodifiedContractBaseAndAllOptionsValue,"dollars");
...
statsummary_continuous(c("UnmodifiedDays","UnmodifiedContractBaseAndAllOptionsValue"), def_serv)
...
sum(def_serv$Action.Obligation[def_serv$n_Fixed==0],na.rm=TRUE)/sum(def_serv$Action.Obligation,na.rm=TRUE)
sum(def_serv$Action.Obligation[def_serv$n_Fixed==0.5],na.rm=TRUE)/sum(def_serv$Action.Obligation,na.rm=TRUE)
sum(def_serv$Action.Obligation[def_serv$n_Fixed==1],na.rm=TRUE)/sum(def_serv$Action.Obligation,na.rm=TRUE)
...
sum(def_serv$Action.Obligation[def_serv$b_UCA==1],na.rm=TRUE)/sum(def_serv$Action.Obligation,na.rm=TRUE)
...
sum(def_serv$Action.Obligation[def_serv$b_Intl==1],na.rm=TRUE)/sum(def_serv$Action.Obligation,na.rm=TRUE)
...
for (i in Agency_Freq$Agency) {
  Percent_Obligation <- round(sum(def_serv$Action.Obligation[def_serv$Agency == i], na.rm = TRUE)/sum(def_serv$Action.Obligation, na.rm = TRUE),5)
...
# 
# Percent_Obli <- c()
# Total_Obli <- sum(def_serv$Action.Obligation, na.rm = TRUE)
# memory.limit(56000)
# for (i in NAICS_Freq$NAICS_Code) {
#   Percent_Obligation <- round(sum(def_serv$Action.Obligation[def_serv$NAICS == i], na.rm = TRUE)/Total_Obli,5)
#   Percent_Obli <- c(Percent_Obli, Percent_Obligation)
#   print(i)
# }
...
for (i in NAICS2_Freq$NAICS_Code) {
  Percent_Obligation <- round(sum(def_serv$Action.Obligation[def_serv$NAICS2 == i], na.rm = TRUE)/Total_Obli,5)
  Percent_Obli <- c(Percent_Obli, Percent_Obligation)
}
...
for (i in Frequency[["NAICS3"]]) {
  Percent_Obligation <- round(sum(def_serv[["Action.Obligation"]][def_serv$NAICS3 == i], na.rm = TRUE)/sum(def_serv[["Action.Obligation"]], na.rm = TRUE),5)
    Percent_Obli <- c(Percent_Obli, Percent_Obligation)
  }
...
def_serv$OptGrowth<-def_serv$ExercisedOptions/def_serv$UnmodifiedBaseandExercisedOptionsValue+1
def_serv$l_OptGrowth<-log(def_serv$OptGrowth)
...
freq_continuous_plot(def_serv %>%filter(AnyUnmodifiedUnexercisedOptions==1),"OptGrowth",bins=50)
freq_continuous_plot(def_serv %>%filter(AnyUnmodifiedUnexercisedOptions==1),"l_OptGrowth",bins=50)
...
# serv_smp$l_Offr<-na_non_positive_log(serv_smp$UnmodifiedNumberOfOffersReceived)
# serv_smp1m$l_Offr<-na_non_positive_log(serv_smp1m$UnmodifiedNumberOfOffersReceived)
...
complete<-
  ...
  !is.na(def_serv$pPBSC)&
!is.na(def_serv$pOffPSC)&
!is.na(def_serv$pMarket)&
!is.na(def_serv$office_entity_numberofactions_1year)&
#Controls
  ...
  !is.na(def_serv$cl_def6_obl_lag1)&
  !is.na(def_serv$cl_def6_ratio_lag1)&
    #New Controls
  !is.na(def_serv$office_numberofactions_1year)&
!is.na(def_serv$office_obligatedamount_7year)&
!is.na(def_serv$pMarket)
...
summary(complete)
money<-def_serv$Action.Obligation
length(money[!complete])/length(money)
sum(money[!complete],na.rm=TRUE)/sum(money,na.rm=TRUE)

nrow(def_serv[!complete,])/nrow(def_serv)
sum(def_serv[!complete,]$Action.Obligation,na.rm=TRUE)/sum(def_serv$Action.Obligation,na.rm=TRUE)
# 
# serv_smp<-def_serv[complete,]
# # 
# serv_smp1m<-serv_smp[sample(nrow(serv_smp),1000000),]
# serv_smp<-serv_smp[sample(nrow(serv_smp),250000),]
save(file="../data/clean/def_sample.Rdata",serv_smp,serv_smp1m)

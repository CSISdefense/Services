...
if(!exists("naics36_When_Office_opt"))
  naics36_When_Office_opt <- lmer(data=serv_opt,
                             l_OptGrowth ~  (1 | NAICS3/NAICS)+ (1 | StartCY) + (1 | Agency/Office)
                             )#, family=binomial(link="logit"))
get_icc(display=TRUE,naics36_When_Office_opt)
...
save(Office_cbre,Office_term,Office_opt,
     ...
     naics36_When_Office_cbre,naics36_When_Office_term,naics36_When_Office_opt,

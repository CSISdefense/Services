...
colnames(def_serv)[colnames(def_serv)=="SteadyScopeOptionRescinded"]<-"SteadyScopeOptionRescision"
  ...
  def_serv$SteadyScopeOptionGrowthAlone+
    ...
    def_serv$SumOfbaseandexercisedoptionsvalue)>1
...
def_serv$n_OptGrowth <- def_serv$SteadyScopeOptionGrowthAlone +
  ifelse(def_serv$SteadyScopeOptionRescision+SteadyScopeOptionGrowthMixed+def_serv$AdminOptionModification<0,
         def_serv$SteadyScopeOptionRescision+SteadyScopeOptionGrowthMixed+def_serv$AdminOptionModification,0)+1

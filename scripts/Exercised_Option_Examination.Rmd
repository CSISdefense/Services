...
#opt_preclean<-def_serv %>% filter(SteadyScopeOptionGrowthAlone>1)
...
summary(opt_preclean$UnmodifiedBase)
```
...
(
ggplot(opt_preclean, aes(x=UnmodifiedBase,y=p_OptGrowth-1)) +#,color=q_OptGrowth
...
(
ggplot(opt_preclean, aes(x=UnmodifiedBase,y=SteadyScopeOptionGrowthAlone)) +#,color=q_OptGrowth
  geom_point(alpha=0.25,shape=".")+
  # theme(axis.text.x = element_text(angle = 90, hjust = 1))+
  scale_x_log10()+scale_y_log10()+
  #+
...
(
ggplot(opt_preclean, aes(x=UnmodifiedBase+SteadyScopeOptionGrowthAlone,y=Action_Obligation.Then.Year)) +#,color=q_OptGrowth
  geom_point(alpha=0.25,shape=".")+
  # theme(axis.text.x = element_text(angle = 90, hjust = 1))+
  scale_x_log10()+scale_y_log10()+
  #+
...
(
ggplot(opt_preclean, aes(x=SteadyScopeOptionGrowthAlone,fill=q_OptGrowth)) +
  geom_histogram(bins=100)+
  theme(axis.text.x = element_text(angle = 90, hjust = 1))+
  scale_x_log10()+
  #+
...
summary(opt_preclean$Ceil[(opt_preclean$p_OptGrowth-1)>10 & opt_preclean$UnmodifiedBase>0 &
                            !is.na(opt_preclean$UnmodifiedBase>0 )])
summary(opt_preclean$Ceil[(opt_preclean$p_OptGrowth-1)>100 & opt_preclean$UnmodifiedBase>0&
                            !is.na(opt_preclean$UnmodifiedBase>0)])
...
opt_preclean$Why_Outlier[is.na(opt_preclean$Why_Outlier)&
                   opt_preclean$Action_Obligation.Then.Year*2>=opt_preclean$UnmodifiedBase+
...
if(any(!is.na(def_serv$SteadyScopeOptionGrowthAlone[

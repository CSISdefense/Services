...
def_serv$OptSpaceUpdated<-(def_serv$UnmodifiedCeiling_Then_Year+def_serv$ChangeOrderCeilingGrowth+
  def_serv$AdminCeilingModification+def_serv$OtherCeilingModification+
  def_serv$SteadyScopeCeilingModification)-def_serv$UnmodifiedBase_Then_Year




def_serv$Exer<-(def_serv$n_OptGrowth_Then_Year-1)/def_serv$OptSpaceOriginal
def_serv$Exer[def_serv$Exer>1]<-1
...
ggplot(data=def_serv, aes(x=Exer))+geom_histogram(bins=100)


ostr(def_serv$Exer)
nrow(def_serv[def_serv$Exer<=0.000001,])
nrow(def_serv[def_serv$n_OptGrowth_Then_Year==0,])

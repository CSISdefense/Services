...
override<-read.delim(file="https://raw.githubusercontent.com/CSISdefense/Lookup-Tables/master/contract/override_lookup.txt", sep="\t") 

inspect250trans<-left_join(inspect250trans,override,by="CSIScontractID")

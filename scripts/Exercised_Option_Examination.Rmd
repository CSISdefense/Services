...
if(file.exists("..\\data\\semi_clean\\serv_opt.rdata")){
  ...
  save(serv_opt,file="..\\data\\semi_clean\\serv_opt.rdata")
}
...
serv_opt$OptSpaceUpdated<-serv_opt$UnmodifiedCeiling_Then_Year+serv_opt$ChangeOrderCeilingGrowth+
  ...
  # ifelse(serv_opt$AdminCeilingModification+serv_opt$SteadyScopeCeilingModification+serv_opt$OtherCeilingModification>0,
  #    serv_opt$AdminCeilingModification+serv_opt$SteadyScopeCeilingModification+serv_opt$OtherCeilingModification,0)-
  serv_opt$UnmodifiedBase_Then_Year
summary(serv_opt$OptSpaceUpdated)



serv_opt$Exer<-(serv_opt$n_OptGrowth_Then_Year-1)/serv_opt$OptSpaceOriginal
serv_opt$Exer[serv_opt$Exer>1]<-1
summary(serv_opt$Exer)
  ...
  serv_opt$ChangeOrderOptionModification+
  serv_opt$SteadyScopeOptionGrowthAlone+
    ...
    serv_opt$EndingOptionModification+
    serv_opt$OtherOptionModification-
    ifelse(is.na(serv_opt$SumOfbaseandexercisedoptionsvalue),
           0,serv_opt$SumOfbaseandexercisedoptionsvalue))>1

#Not included in the ceiling.
#ChangeOrderCeilingRescision
#EndingCeilingModification+
#OtherCeilingModification+


ggplot(data=serv_opt, aes(x=Exer))+geom_histogram(bins=100)

...
serv_opt$OptSpace<-serv_opt$UnmodifiedCeiling_Then_Year-serv_opt$UnmodifiedBase_Then_Year
summary(serv_opt$OptSpace)
serv_opt$Exer<-(serv_opt$n_OptGrowth_Then_Year-1)/serv_opt$OptSpace
...
(serv_opt$UnmodifiedCeiling_Then_Year+serv_opt$ChangeOrderCeilingGrowth+
  serv_opt$AdminCeilingModification+serv_opt$OtherCeilingModification+
  serv_opt$SteadyScopeCeilingModification)-

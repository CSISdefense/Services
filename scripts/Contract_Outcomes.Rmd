...
corrdisp<-Hmisc::rcorr(as.matrix(cbind(subset(serv_smp, select=c(b_UCA,
                                                             c_OffCri,cl_Ceil,
                                               cl_Days,n_Fixed,b_Intl)),
                       dummies::dummy(serv_smp$Crisis),
                       dummies::dummy(serv_smp$NoCompOffr))))
corrdisp[[1]]
summary_continuous_plot(serv_smp,"OffCri",bins=50)


#Ceiling Breaches
gridExtra::grid.arrange(freq_continuous_cbre_plot(serv_smp,"c_OffCri"),
             binned_percent_cbre_plot(serv_smp,"c_OffCri")+geom_vline(xintercept=c(0.1,0.10,0.25)))


#Terminations
gridExtra::grid.arrange(freq_continuous_term_plot(serv_smp,"c_OffCri"),
                        binned_percent_term_plot(serv_smp,"c_OffCri")+geom_vline(xintercept=c(0.1,0.10,0.25)))
...
Term_04A <- glm (data=large_serv_smp,
...
summary_continuous_plot(serv_smp,"OffIntl",bins=50)
summary_continuous_plot(serv_smp,"OffIntl","Crisis",bins=50)

corrdisp<-Hmisc::rcorr(as.matrix(cbind(subset(serv_smp, select=c(
...
Term_04B <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr +
                   b_UCA+OffIntl+
                  NoCompOffr:Crisis, 
                 family=binomial(link="logit"))
...
```{r Model04C}
summary_double_continuous(serv_smp,"OffIntl","c_OffCri")
summary_continuous_plot(serv_smp,"OffIntl","Crisis",bins=40)
...
Term_04C <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffIntl+c_OffCri+
                  NoCompOffr:Crisis+
...
serv_smp$sqrt_OffIntl<-sqrt(serv_smp$OffIntl)


quantile(fed$OffIntl,c(0.1,0.25,0.33,0.4,0.45,0.5,0.6,0.66,0.7,0.75,0.8),na.rm = TRUE)
quantile(serv_smp$OffIntl,c(0.25,0.5,0.6,0.66,0.7,0.75,0.8),na.rm = TRUE)


serv_smp$OffPl99<-Hmisc::cut2(serv_smp$OffIntl,c(0.01,0.50))
summary(serv_smp$OffPl99)
  levels(serv_smp$OffPl99) <-
...
corrdisp<-Hmisc::rcorr(as.matrix(cbind(subset(serv_smp, select=c(
  ...
  dummies::dummy(serv_smp$Crisis),
  dummies::dummy(serv_smp$NoCompOffr),
  dummies::dummy(serv_smp$OffPl99))))
...
summary_discrete_plot(serv_smp,"OffPl99")
summary_continuous_plot(serv_smp,"OffIntl",bins=100)


# summary_continuous_plot(serv_smp,"sqrt_OffIntl",bins=100)


#Crisis
summary_discrete_plot(serv_smp,"OffPl99","Crisis")
summary_continuous_plot(serv_smp,"OffIntl","Crisis",bins=100)
# summary_continuous_plot(serv_smp,"sqrt_OffIntl","Crisis",bins=100)
...
#Office Place
#Ceiling Breaches
gridExtra::grid.arrange(freq_continuous_cbre_plot(serv_smp,"sqrt_OffIntl",bins=50)+aes(fill=OffPl99)+geom_vline(xintercept=c(0.1,1.73)),
             binned_percent_cbre_plot(serv_smp,"sqrt_OffIntl",bins=50)+geom_vline(xintercept=c(0.1,1.73)))


#Terminations
gridExtra::grid.arrange(freq_continuous_term_plot(serv_smp,"sqrt_OffIntl",bins=50)+aes(fill=OffPl99),
                        binned_percent_term_plot(serv_smp,"sqrt_OffIntl",bins=50)+geom_vline(xintercept=c(0.1,1.87)))


#Office Place crossreferenced with Crisis
#Ceiling Breaches
gridExtra::grid.arrange(freq_continuous_cbre_plot(serv_smp,"sqrt_OffIntl","Crisis",bins=50)+aes(fill=OffPl99),
             binned_percent_cbre_plot(serv_smp,"sqrt_OffIntl","Crisis",bins=50)+geom_vline(xintercept=c(0.1,1.87)))


#Terminations
gridExtra::grid.arrange(freq_continuous_term_plot(serv_smp,"sqrt_OffIntl","Crisis",bins=50)+aes(fill=OffPl99),
                        binned_percent_term_plot(serv_smp,"sqrt_OffIntl","Crisis",bins=50)+geom_vline(xintercept=c(0.1,1.87)))
...
Term_04D <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+
                   NoCompOffr:Crisis+
...
summary_continuous_plot(serv_smp,"OffCri","OffPl99",bins=50)


sum(serv_smp$Action.Obligation[ serv_smp$OffIntl<0.01],na.rm=TRUE)/
  sum(serv_smp$Action.Obligation,na.rm=TRUE)
sum(serv_smp$Action.Obligation[ serv_smp$OffIntl<0.05&
                                   serv_smp$OffIntl>=0.01],na.rm=TRUE)/
  sum(serv_smp$Action.Obligation,na.rm=TRUE)
sum(serv_smp$Action.Obligation[ serv_smp$OffIntl<0.25&
                                   serv_smp$OffIntl>=0.05],na.rm=TRUE)/
  sum(serv_smp$Action.Obligation,na.rm=TRUE)
sum(serv_smp$Action.Obligation[ serv_smp$OffIntl>=0.25&
                                   serv_smp$OffIntl<0.50],na.rm=TRUE)/
  sum(serv_smp$Action.Obligation,na.rm=TRUE)
sum(serv_smp$Action.Obligation[ serv_smp$OffIntl>=0.50],na.rm=TRUE)/
  sum(serv_smp$Action.Obligation,na.rm=TRUE)
...
#Ceiling Breaches
gridExtra::grid.arrange(freq_discrete_cbre_plot(serv_smp,"OffPl99"),
                        discrete_percent_cbre_plot(serv_smp,"OffPl99"))
                        
#Terminations
gridExtra::grid.arrange(freq_discrete_term_plot(serv_smp,"OffPl99"),
                        discrete_percent_term_plot(serv_smp,"OffPl99"))



#Ceiling Breaches
gridExtra::grid.arrange(freq_discrete_cbre_plot(serv_smp,"OffPl99","Crisis"),
                        discrete_percent_cbre_plot(serv_smp,"OffPl99","Crisis"))
                        
#Terminations
gridExtra::grid.arrange(freq_discrete_term_plot(serv_smp,"OffPl99","Crisis"),
                        discrete_percent_term_plot(serv_smp,"OffPl99","Crisis"))



#Office Place
#Ceiling Breaches
gridExtra::grid.arrange(freq_continuous_cbre_plot(serv_smp,"sqrt_OffIntl",bins=50)+aes(fill=OffPl99),
             binned_percent_cbre_plot(serv_smp,"sqrt_OffIntl",bins=50)+geom_vline(xintercept=c(0.1,0.25,1.87)))


#Terminations
gridExtra::grid.arrange(freq_continuous_term_plot(serv_smp,"sqrt_OffIntl",bins=50)+aes(fill=OffPl99),
                        binned_percent_term_plot(serv_smp,"sqrt_OffIntl",bins=50)+geom_vline(xintercept=c(0.1,0.25,1.87)))


#Office Place crossreferenced with Crisis
#Ceiling Breaches
gridExtra::grid.arrange(freq_continuous_cbre_plot(serv_smp,"sqrt_OffIntl","Crisis",bins=50)+aes(fill=OffPl99),
             binned_percent_cbre_plot(serv_smp,"sqrt_OffIntl","Crisis",bins=50)+geom_vline(xintercept=c(0.1,0.25,1.87)))


#Terminations
gridExtra::grid.arrange(freq_continuous_term_plot(serv_smp,"sqrt_OffIntl","Crisis",bins=50)+aes(fill=OffPl99),
                        binned_percent_term_plot(serv_smp,"sqrt_OffIntl","Crisis",bins=50)+geom_vline(xintercept=c(0.1,0.25,1.87)))


#Model
CBre_04E <- glm (data=serv_smp,
                 b_CBre ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+c_OffCri+
                  Crisis:NoCompOffr+
...
Term_04E <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+c_OffCri+
                  NoCompOffr:Crisis+
...
serv_smp$OffPl95<-Hmisc::cut2(serv_smp$OffIntl,c(0.05,0.75))


summary(serv_smp$OffPl95)
  levels(serv_smp$OffPl95) <-
    list("US95"=c("[0.00,0.05)"),
         "Mixed75"=c("[0.05,0.75)"),
         "Intl"=c("[0.75,1.00]"))

summary_discrete_plot(serv_smp,"OffPl95")
summary_discrete_plot(serv_smp,"Intl","OffPl95")


#Model
CBre_04F <- glm (data=serv_smp,
                 b_CBre ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl95+
                  Crisis:NoCompOffr+
...
Term_04F <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl95+
                  NoCompOffr:Crisis+
...
summary_continuous_plot(serv_smp,"OffCri","OffPl95",bins=50)



#Office Place crossreferenced with Crisis
#Ceiling Breaches
gridExtra::grid.arrange(freq_continuous_cbre_plot(serv_smp,"sqrt_OffIntl","Crisis",bins=50)+aes(fill=OffPl95),
             binned_percent_cbre_plot(serv_smp,"sqrt_OffIntl","Crisis",bins=50)+geom_vline(xintercept=c(0.1,0.5,1.87)))


#Terminations
gridExtra::grid.arrange(freq_continuous_term_plot(serv_smp,"sqrt_OffIntl","Crisis",bins=50)+aes(fill=OffPl95),
                        binned_percent_term_plot(serv_smp,"sqrt_OffIntl","Crisis",bins=50)+geom_vline(xintercept=c(0.1,0.5,1.87)))

#Model
CBre_04G <- glm (data=serv_smp,
                 b_CBre ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl95+c_OffCri+
                  Crisis:NoCompOffr+
...
Term_04G <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl95+c_OffCri+
                  NoCompOffr:Crisis+
...
serv_smp$OffPl50<-Hmisc::cut2(serv_smp$OffIntl,c(0.50))
summary(serv_smp$OffPl50)
summary_discrete_plot(serv_smp,"Intl","OffPl50")
...
corrdisp<-Hmisc::rcorr(as.matrix(cbind(subset(serv_smp, select=c(
  ...
  dummies::dummy(serv_smp$Crisis),
  dummies::dummy(serv_smp$NoCompOffr),
  dummies::dummy(serv_smp$OffPl50))))

corrdisp[[1]]

  levels(serv_smp$OffPl50) <-
    list("US50"=c("[0.0,0.5)"),
         "Intl50"=c("[0.5,1.0]"))
...
summary_discrete_plot(serv_smp,"OffPl50")


#Model
CBre_04H <- glm (data=serv_smp,
                 b_CBre ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl50+
                  Crisis:NoCompOffr+
...
summary_continuous_plot(serv_smp,"OffCri","OffPl50",bins=50)



#Office Place crossreferenced with Crisis
#Ceiling Breaches
gridExtra::grid.arrange(freq_continuous_cbre_plot(serv_smp,"sqrt_OffIntl","Crisis",bins=50)+aes(fill=OffPl50),
             binned_percent_cbre_plot(serv_smp,"sqrt_OffIntl","Crisis",bins=50)+geom_vline(xintercept=c(0.5,1.87)))


#Terminations
gridExtra::grid.arrange(freq_continuous_term_plot(serv_smp,"sqrt_OffIntl","Crisis",bins=50)+aes(fill=OffPl50),
                        binned_percent_term_plot(serv_smp,"sqrt_OffIntl","Crisis",bins=50)+geom_vline(xintercept=c(0.5,1.87)))

#Model
CBre_04I <- glm (data=serv_smp,
                 b_CBre ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl50+c_OffCri+
                  Crisis:NoCompOffr+
...
Term_04I <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl50+c_OffCri+
                  NoCompOffr:Crisis+
...
summary_discrete_plot(serv_smp,"UCA","OffPl99")
summary_continuous_plot(serv_smp,"OffCri","UCA",bins=50)
summary_discrete_plot(serv_smp,"UCA","Crisis")

#Model



CBre_04J <- glm (data=serv_smp,
                 b_CBre ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+c_OffCri+
                   Crisis:NoCompOffr+
...
Term_04J <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+c_OffCri+
                   NoCompOffr:Crisis+
...
summary_discrete_plot(serv_smp,"OffPl99","Crisis")
summary_continuous_plot(serv_smp,"OffCri","Crisis")


#Model
CBre_04K <- glm (data=serv_smp,
                 b_CBre ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ c_OffCri+
                  Crisis:NoCompOffr+
...
Term_04K <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ c_OffCri+
                  NoCompOffr:Crisis+
...
```{r Model04L}
summary_discrete_plot(serv_smp,"OffPl99","NoCompOffr")
summary_discrete_plot(serv_smp,"NoCompOffr","OffPl99")
summary_continuous_plot(serv_smp,"OffCri","NoCompOffr")



#Model
CBre_04L <- glm (data=serv_smp,
                 b_CBre ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ c_OffCri+
                  Crisis:NoCompOffr+
...
Term_04L <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ c_OffCri+
                  NoCompOffr:Crisis+
...
Term_05A <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+
...
summary_continuous_plot(serv_smp,"l_Ceil","Crisis")
summary_continuous_plot(serv_smp,"l_Ceil","c_OffCri")
...
Term_05B <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ c_OffCri+
                  cl_Ceil+
...
summary_continuous_plot(serv_smp,"l_Ceil","c_OffCri")
summary_continuous_plot(serv_smp,"l_Ceil","OffPl99")
summary_continuous_plot(serv_smp,"l_Ceil","UCA")
#Model
CBre_05C <- glm (data=large_serv_smp,
                 b_CBre ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ 
                   c_OffCri+
...
Term_05C <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr+
                   b_UCA+
                   OffPl99+ c_OffCri+
                  cl_Ceil+
...
summary_double_continuous(large_serv_smp,"l_Ceil","c_OffCri")
summary_continuous_plot(large_serv_smp,"l_Ceil","OffPl99")

#Model
CBre_05D <- glm (data=large_serv_smp,
                 b_CBre ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+
...
Term_05D <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr+
                   b_UCA+
                   OffPl99+ c_OffCri+
                  cl_Ceil+
...
```{r Model05E}
summary_continuous_plot(large_serv_smp,"l_Ceil","NoCompOffr")
#Model
CBre_05E <- glm (data=large_serv_smp,
                 b_CBre ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+
...
Term_05E <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr+
                   b_UCA+
                   OffPl99+ c_OffCri+
                  cl_Ceil+
...
Term_05E2 <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr+
                   b_UCA+
                   OffPl99+ c_OffCri+
                  cl_Ceil+
...
```{r Model05F}
#Frequency Plot for unlogged ceiling
large_serv_smp$sqrt_ceil<-sqrt(large_serv_smp$UnmodifiedContractBaseAndAllOptionsValue)
large_serv_smp$csqrt_ceil<-scale(large_serv_smp$sqrt_ceil)
freq_continuous_cbre_plot(large_serv_smp,"sqrt_ceil",
               bins=1000)

summary_continuous_plot(large_serv_smp,"csqrt_ceil",bins=50)
summary(large_serv_smp$l_Ceil)

str(large_serv_smp)
#Model
CBre_05F <- glm (data=large_serv_smp,
                 b_CBre ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+csqrt_ceil+
...
Term_05F <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+csqrt_ceil+
...
freq_continuous_plot(large_serv_smp,"l_Ceil",
               bins=100)+geom_vline(xintercept=log(2500))

freq_continuous_plot(large_serv_smp,"l_Ceil","Veh",
               bins=100)+geom_vline(xintercept=log(2500))

binned_percent_plot(large_serv_smp,"l_Ceil",bins=100)+
  geom_vline(xintercept=log(2500))+
  geom_vline(xintercept=log(150000))

binned_percent_plot(large_serv_smp,"l_Ceil","Veh",bins=100)+
  geom_vline(xintercept=log(2500))+
  geom_vline(xintercept=log(150000))
```
...
```{r Model05G}
large_serv_smp$thresh<-Hmisc::cut2(large_serv_smp$UnmodifiedContractBaseAndAllOptionsValue,c(2500,15000))

levels(large_serv_smp$thresh)<-c("25C","150K","Above")
large_serv_smp$thresh<-factor(large_serv_smp$thresh,levels=c("Above","150K","25C"))


summary(large_serv_smp$thresh)
summary_discrete_plot(large_serv_smp,"thresh")



#Model
CBre_05G <- glm (data=large_serv_smp,
                 b_CBre ~  Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ c_OffCri+
...
Term_05G <- glm (data=large_serv_smp,
                  b_Term ~ Crisis +NoCompOffr+
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+cl_Ceil:thresh+
...
Term_05G2 <- glm (data=large_serv_smp,
                  b_Term ~ Crisis +NoCompOffr+
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+cl_Ceil:thresh+
...
```{r Model05H}
summary_continuous_plot(large_serv_smp,"cl_ceil","thresh")



#Model
CBre_05H <- glm (data=large_serv_smp,
                 b_CBre ~  Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+thresh+
...
Term_05H <- glm (data=large_serv_smp,
                  b_Term ~ Crisis +NoCompOffr+
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+thresh+
...
freq_continuous_cbre_plot(large_serv_smp,"UnmodifiedDays",
               bins=1000)



summary_continuous_plot(large_serv_smp,"l_Days")
#Model
CBre_06A <- glm (data=large_serv_smp,
                 b_CBre ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+
...
Term_06A <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr+
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+
...
summary_double_continuous(large_serv_smp,"capped_cl_Days","cl_Ceil")

#Model
CBre_06B <- glm (data=large_serv_smp,
                 b_CBre ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+
...
Term_06B <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr+
                   b_UCA+
                   OffPl99+ c_OffCri+
                  cl_Ceil+
...
summary_continuous_plot(large_serv_smp,"l_Days","Crisis")

#Model
CBre_06C <- glm (data=large_serv_smp,
                 b_CBre ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+
...
Term_06C <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr+
                   b_UCA+
                   OffPl99+ c_OffCri+
                  cl_Ceil+
...
summary_continuous_plot(large_serv_smp,"l_Days","UCA")

#Model
CBre_06D <- glm (data=large_serv_smp,
                 b_CBre ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+
...
Term_06D <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr+
                   b_UCA+
                   OffPl99+ c_OffCri+
                  cl_Ceil+
...
```{r Mode06E}
summary_double_continuous(large_serv_smp,"l_Days","c_OffCri")
summary_continuous_plot(large_serv_smp,"l_Days","OffPl99")


#Model
CBre_06E <- glm (data=large_serv_smp,
                 b_CBre ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+
...
Term_06E <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr+
                   b_UCA+
                   OffPl99+ c_OffCri+
                  cl_Ceil+
...
```{r Mode06F}
summary_continuous_plot(large_serv_smp,"l_Days","NoCompOffr")


#Model
CBre_06F <- glm (data=large_serv_smp,
                 b_CBre ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+
...
Term_06F <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr+
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+
...
```{r Model07A}
  ...
  summary_discrete_plot(large_serv_smp,"Veh")

#Model
CBre_07A <- glm (data=large_serv_smp,
                 b_CBre ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+
...
Term_07A <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr+
                   b_UCA+
                   OffPl99+ c_OffCri+
                  cl_Ceil+
...
```{r Model07B}
  ...
  summary_continuous_plot(large_serv_smp,"l_Days","Veh")

#Model
CBre_07B <- glm (data=large_serv_smp,
                 b_CBre ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+
...
Term_07B <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr+
                   b_UCA+
                   OffPl99+ c_OffCri+
                  cl_Ceil+
...
summary_continuous_plot(large_serv_smp,"l_Ceil","Veh",bins=50)
freq_continuous_plot(subset(large_serv_smp,Veh=="M-IDC"),"l_Ceil","Crisis",bins=50)+
  geom_vline(xintercept=c(log(12500),log(17500)))
summary_continuous_plot(subset(large_serv_smp,Veh=="M-IDC"& Crisis=="ARRA"),
                        "l_Ceil",bins=50)
#Model
CBre_07C <- glm (data=large_serv_smp,
                 b_CBre ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+
...
CBre_07C2 <- glm (data=large_serv_smp,
                 b_CBre ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+
...
Term_07C <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr+
                   b_UCA+
                   OffPl99+ c_OffCri+
                  cl_Ceil+
...
```{r Model07D}
  ...
  summary_discrete_plot(large_serv_smp,"NoCompOffr","Veh")

#Model
CBre_07D <- glm (data=large_serv_smp,
                 b_CBre ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+
...
CBre_07D2 <- glm (data=large_serv_smp,
                 b_CBre ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+
...
CBre_07D3 <- glm (data=large_serv_smp,
                 b_CBre ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+
...
Term_07D <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr+
                   b_UCA+
                   OffPl99+ c_OffCri+
                  cl_Ceil+
...
summary(large_serv_smp$Term[large_serv_smp$NoCompOffr=="Urgency"&large_serv_smp$Veh=="M-IDC"])
...
```{r Model08A}
  ...
  summary_discrete_plot(large_serv_smp,"FxCb")

#Model
CBre_08A <- glm (data=large_serv_smp,
                 b_CBre ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+
...
Term_08A <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr+
                   b_UCA+
                   OffPl99+ c_OffCri+
                  cl_Ceil+
...
```{r Model08B}
  ...
  summary_continuous_plot(large_serv_smp,"l_Days","FxCb")

#Model
CBre_08B <- glm (data=large_serv_smp,
                 b_CBre ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+
...
Term_08B <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr+
                   b_UCA+
                   OffPl99+ c_OffCri+
                  cl_Ceil+
...
```{r Model08C}
  ...
  summary_discrete_plot(large_serv_smp,"FxCb","Veh")

#Model
CBre_08C <- glm (data=large_serv_smp,
                 b_CBre ~ Crisis +NoCompOffr +
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+
...
Term_08C <- glm (data=large_serv_smp,
                 b_Term ~ Crisis +NoCompOffr+
                   b_UCA+
                   OffPl99+ c_OffCri+
                  cl_Ceil+
...
```{r Model08D}
  ...
  summary_continuous_plot(large_serv_smp,"l_Ceil","FxCb")
  
  #Model
summary_discrete_plot(large_serv_smp,"FxCb","Crisis")
  
  #Model
  CBre_08D <- glm (data=large_serv_smp,
                   b_CBre ~ Crisis +NoCompOffr +
                     b_UCA+
                     OffPl99+ c_OffCri+
                     cl_Ceil+
  ...
  Term_08D <- glm (data=large_serv_smp,
                   b_Term ~ Crisis +NoCompOffr+
                     b_UCA+
                     OffPl99+ c_OffCri+
                    cl_Ceil+
...
```{r Model08E}
  ...
  CBre_08E <- glm (data=large_serv_smp,
                   b_CBre ~ Crisis +NoCompOffr +
                     b_UCA+
                     OffPl99+ c_OffCri+
                     cl_Ceil+
  ...
  Term_08E <- glm (data=large_serv_smp,
                   b_Term ~ Crisis +NoCompOffr+
                     b_UCA+
                     OffPl99+ c_OffCri+
                    cl_Ceil+
...
```{r Model08F}
  summary_discrete_plot(large_serv_smp,"n_Fixed","NoCompOffr")
summary_discrete_plot(large_serv_smp,"n_Fixed","FxCb")
  

  CBre_08F <- glm (data=large_serv_smp,
                   b_CBre ~ Crisis +NoCompOffr +
                     b_UCA+
                     OffPl99+ c_OffCri+
                     cl_Ceil+
  ...
  Term_08F <- glm (data=large_serv_smp,
                   b_Term ~ Crisis +NoCompOffr+
                     b_UCA+
                     OffPl99+ c_OffCri+
                    cl_Ceil+
...
```{r Model08G}
  ...
  CBre_08G <- glm (data=large_serv_smp,
                   b_CBre ~ Crisis +NoCompOffr +
                     b_UCA+
                     OffPl99+ c_OffCri+
                     cl_Ceil+
  ...
  Term_08G <- glm (data=large_serv_smp,
                   b_Term ~ Crisis +NoCompOffr+
                     b_UCA+
                     OffPl99+ c_OffCri+
                    cl_Ceil+
...
```{r Model08H}
  summary_discrete_plot(large_serv_smp,"Pricing",rotate_text = TRUE)


  CBre_08H <- glm (data=large_serv_smp,
                   b_CBre ~ Crisis +NoCompOffr +
                     b_UCA+
                     OffPl99+ c_OffCri+
                     cl_Ceil+
  ...
  Term_08H <- glm (data=large_serv_smp,
                   b_Term ~ Crisis +NoCompOffr+
                     b_UCA+
                     OffPl99+ c_OffCri+
                    cl_Ceil+
...
```{r Model08I}
 #  summary_discrete_plot(large_serv_smp,"Pricing")
 ...
 #            "Intl-Intl"=c("Intl-Any International"))
  ...
  CBre_08I <- glm (data=large_serv_smp,
                   b_CBre ~ Crisis +NoCompOffr +
                     b_UCA+
                     OffPl99+ c_OffCri+
                     cl_Ceil+
  ...
  Term_08I <- glm (data=large_serv_smp,
                   b_Term ~ Crisis +NoCompOffr+
                     b_UCA+
                     OffPl99+ c_OffCri+
                    cl_Ceil+
...
```{r Model08J}
 #  summary_discrete_plot(large_serv_smp,"Pricing")
large_serv_smp$PricingBasis<-large_serv_smp$Pricing



 levels(large_serv_smp$PricingBasis) <-
      list( "Fixed-Price"=c("FFP","Other FP"),
            "Comb. or Other"=c("Combination or Other"),
            "T&M/LH/FPLOE" =c("T&M/LH/FPLOE"),
             "Cost-Based"=c( "Cost-Based"))

   summary_discrete_plot(large_serv_smp,"PricingBasis")
 
  CBre_08J <- glm (data=large_serv_smp,
                   b_CBre ~ Crisis +NoCompOffr +
                     b_UCA+
                     OffPl99+ c_OffCri+
                     cl_Ceil+
  ...
  Term_08J <- glm (data=large_serv_smp,
                   b_Term ~ Crisis +NoCompOffr+
                     b_UCA+
                     OffPl99+ c_OffCri+
                    cl_Ceil+
...
```{r Model09A}
corrdisp<-Hmisc::rcorr(as.matrix(cbind(subset(large_serv_smp, select=c(b_UCA,
                                                             c_OffCri,cl_Ceil,
                                               capped_cl_Days,b_Intl)),
                                       dummies::dummy(large_serv_smp$PricingBasis),
                       dummies::dummy(large_serv_smp$Crisis),
                       dummies::dummy(large_serv_smp$NoCompOffr),
                       dummies::dummy(large_serv_smp$OffPl99),
                       dummies::dummy(large_serv_smp$Veh))))

corrdisp[[1]]#[,1:9]



  CBre_09A <- glm (data=large_serv_smp,
                   b_CBre ~ Crisis +NoCompOffr +
                     b_UCA+
                     b_Intl+
                     c_OffCri+
  ...
  Term_09A <- glm (data=large_serv_smp,
                   b_Term ~ Crisis +NoCompOffr+
                     b_UCA+
                     c_OffCri+
                     b_Intl+
...
```{r Model09B}
  ...
  summary_discrete_plot(large_serv_smp,"Intl","OffPl99")

    levels(large_serv_smp$Reach6) <-
    ...
    summary_discrete_plot(large_serv_smp,"Reach6")
  

  CBre_09B <- glm (data=large_serv_smp,
                   b_CBre ~ Crisis +NoCompOffr +
                     b_UCA+
                     c_OffCri+
                     Reach6+
  ...
  Term_09B <- glm (data=large_serv_smp,
                   b_Term ~ Crisis +
                     NoCompOffr+
                     b_UCA+
                     c_OffCri+
...
```{r Model09C}
    ...
    summary_discrete_plot(large_serv_smp,"Reach")
  

  CBre_09C <- glm (data=large_serv_smp,
                   b_CBre ~ Crisis +NoCompOffr +
                     b_UCA+
                     c_OffCri+
                     Reach+
  ...
  Term_09C <- glm (data=large_serv_smp,
                   b_Term ~ Crisis +NoCompOffr+
                     b_UCA+
                     c_OffCri+
                     Reach++
...
```{r Model09D}
    ...
    summary_discrete_plot(large_serv_smp,"Reach5")
  

  CBre_09D <- glm (data=large_serv_smp,
                   b_CBre ~ Crisis +NoCompOffr +
                     b_UCA+
                     c_OffCri+
                     Reach5+
  ...
  Term_09D <- glm (data=large_serv_smp,
                   b_Term ~ Crisis +NoCompOffr+
                     b_UCA+
                     c_OffCri+
                     Reach5++
...
# summary(large_serv_smp$ServCommCons)
# summary(large_serv_smp$CPSA)
if(!exists("CBre_20A"))
  CBre_20A <- glmer (data=large_serv_smp,
...
if(!exists("Term_20A"))
  Term_20A <- glmer (data=large_serv_smp,
...
if(!exists("CBre_20B"))
  CBre_20B <- glmer (data=large_serv_smp,
                   b_CBre ~ Crisis +NoComp +
                     b_UCA+
                     OffPl99+#Reach+ 
                     cl_Ceil+
...
if(!exists("Term_20B"))
  Term_20B <- glmer (data=large_serv_smp,
                   b_Term ~ Crisis +NoComp+
                     b_UCA+
                     # c_OffCri+
                     OffPl99+#Reach+ 
...
if(!exists("CBre_20C"))
  CBre_20C <- glmer (data=large_serv_smp,
                   b_CBre ~ Crisis +NoComp +
                     b_UCA+
                     OffPl99+#Reach+ 
                     cl_Ceil+
  ...
  # if(!exists("Term_20C"))
  # Term_20C <-  glmer (data=large_serv_smp,
  #                  b_Term ~ Crisis +NoComp+
  #                    b_UCA+
  #                    # c_OffCri+
  #                    Reach+ 
...
if(!exists("CBre_20D"))
  CBre_20D <- glmer (data=large_serv_smp,
                   b_CBre ~ Crisis +NoComp +
                     b_UCA+
                     Reach+ 
                     cl_Ceil+
...
if(!exists("Term_20D"))
  Term_20D <- glmer (data=large_serv_smp,
                   b_Term ~ Crisis +NoComp+
                     b_UCA+
                     # c_OffCri+
                     Reach+ 
...
if(!exists("CBre_20E"))
  CBre_20E <- glmer (data=large_serv_smp,
                   b_CBre ~ Crisis +NoCompOffr +
                     b_UCA+
                     Reach+ 
                     cl_Ceil+
...
# if(!exists("Term_20E"))
#   Term_20E <- glmer (data=large_serv_smp,
#                    b_Term ~ Crisis +NoCompOffr+
#                      b_UCA+
#                      # c_OffCri+
#                      Reach+ 
...
if(!exists("CBre_20F"))
  CBre_20F <- glmer (data=large_serv_smp,
                   b_CBre ~ Crisis +NoCompOffr +
                     b_UCA+
                     Reach+ 
                     cl_Ceil+
...
# if(!exists("Term_20F"))
#   Term_20F <- glmer (data=large_serv_smp,
#                    b_Term ~ Crisis +NoCompOffr+
#                      b_UCA+
#                      # c_OffCri+
#                      Reach+ 
...
if(!exists("CBre_20G"))
  CBre_20G <- glmer (data=large_serv_smp,
                   b_CBre ~ Crisis +NoCompOffr +
                     b_UCA+
                     OffPlace+ 
                     cl_Ceil+
...
if(!exists("Term_20G"))
  Term_20G <- glmer (data=large_serv_smp,
                   b_Term ~ Crisis +NoCompOffr+
                     b_UCA+
                     # c_OffCri+
                     OffPlace+ 

...
ggplot(serv_opt, aes(x=cl_US6_avg_sal_lag1Const, y=l_OptGrowth)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))
...
Opt_01A <- glm(data=serv_opt,
                        l_OptGrowth ~ cl_US6_avg_sal_lag1Const)
...
Opt_01C <- glm(data=serv_opt,
                        l_OptGrowth ~ cl_US6_avg_sal_lag1Const +  cl_CFTE)
...
rm(CBre_01A,CBre_01B, Term_01A, Term_01B, Opt_01A, Opt_01B)
```
...
summary_residual_compare(CBre_02B,CBre_02C,Term_02B,Term_02C)
...
Opt_02D <- glm(data=serv_opt,
                        l_OptGrowth ~ cl_US6_avg_sal_lag1Const + cl_CFTE+ c_pPBSC+c_pOffPSC)
...
rm(CBre_01C,CBre_02A, CBre_02B, CBre_02C, Term_01C, Term_02A,Term_02B,Term_02C, Opt_01C, Opt_02A, Opt_02B, Opt_02C)
```
...
rm(CBre_02D, CBre_03A, CBre_03B, CBre_03C, Term_02D, Term_03A, Term_03B, Term_03C, Opt_02D, Opt_03A, Opt_03B, Opt_03C)
```
...
rm(CBre_03D, CBre_04A, CBre_04B, CBre_04C, Term_03D, Term_04A, Term_04B, Term_04C, Opt_03D, Opt_04A, Opt_04B, Opt_04C)
...
stargazer::stargazer(CBre_04D,CBre_05A,CBre_05B,
                       Term_04D,Term_05A,Term_05B,
                       Opt_04D,Opt_05A,Opt_05B,
                       type="text",
                       digits=2)
...
#summary_residual_compare(CBre_04D,CBre_05B,Term_04D,Term_05B)
 ...
 rm(CBre_04D, CBre_05A, Term_04D, Term_05A, Opt_04D, Opt_05A)
```
...
#Scatter Plot
ggplot(serv_opt, aes(x=Veh, y=l_OptGrowth)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))

#Model
CBre_06A <- glm (data=serv_smp,
...
Opt_06A <- glm(data=serv_opt,
                        l_OptGrowth ~ Veh)

display(Opt_06A)
#Plot residuals versus fitted
stargazer::stargazer(CBre_05B,CBre_06A,
                       Term_05B,Term_06A,
                       Opt_05B,Opt_06A,
                       type="text",
                       digits=2)

#summary_residual_compare(CBre_05D,CBre_06A,Term_05D,Term_06A)
...
glmer_examine(Opt_06B)

#Plot residuals versus fitted   

stargazer::stargazer(CBre_05B,CBre_06A,CBre_06B,
                       Term_05B,Term_06A,Term_06B,
                       Opt_05B,Opt_06A,Opt_06B,
                       type="text",
                       digits=2)


#summary_residual_compare(CBre_05B,CBre_06B,Term_05B,Term_06B)

rm(CBre_05B, CBre_06A, Term_05B, Term_06A, Opt_05B, Opt_06A)
```
...
#Scatter Plot
ggplot(serv_opt, aes(x=PricingUCA, y=l_OptGrowth)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))
...
Opt_07A <- glm(data=serv_opt,
                        l_OptGrowth ~ PricingUCA)

display(Opt_07A)
#Plot residuals versus fitted
stargazer::stargazer(CBre_06B,CBre_07A,
                       Term_06B,Term_07A,
                       Opt_06B,Opt_07A,
                       type="text",
                       digits=2)
...
#summary_residual_compare(CBre_06B,CBre_07A,Term_06B,Term_07A,30)
...
glmer_examine(Opt_07B)

#Plot residuals versus fitted   

stargazer::stargazer(CBre_06B,CBre_07A,CBre_07B,
                       Term_06B,Term_07A,Term_07B,
                       Opt_06B,Opt_07A,Opt_07B,
                       type="text",
                       digits=2)


#summary_residual_compare(CBre_06B,CBre_07B,Term_06B,Term_07B)
#summary_residual_compare(CBre_07A,CBre_07B,Term_07A,Term_07B,bins=3)

rm(CBre_06B, CBre_07A, Term_06B, Term_07A, Opt_06B, Opt_07A)
```
...
#Scatter Plot
ggplot(serv_opt, aes(x=Crisis, y=l_OptGrowth)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))
...
Opt_08A <- glm(data=serv_opt,
                        l_OptGrowth ~ Crisis)

display(Opt_08A)
#Plot residuals versus fitted
stargazer::stargazer(CBre_07B,CBre_08A,
                       Term_07B,Term_08A,
                       Opt_07B,Opt_08A,
                       type="text",
                       digits=2)
...
# summary_residual_compare(CBre_07B,CBre_08A,Term_07B,Term_08A,30)
...
glmer_examine(Opt_08B)

#Plot residuals versus fitted   

stargazer::stargazer(CBre_07B,CBre_08A,CBre_08B,
                       Term_07B,Term_08A,Term_08B,
                       Opt_07B,Opt_08A,Opt_08B,
                       type="text",
                       digits=2)


#summary_residual_compare(CBre_07B,CBre_08B,Term_07B,Term_08B)

rm(CBre_07B, CBre_08A,Term_07B, Term_08A, Opt_07B, Opt_08A)
```
...
#Scatter Plot
ggplot(serv_opt, aes(x=cl_def6_HHI_lag1, y=l_OptGrowth)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))
...
Opt_09A <- glm(data=serv_opt,
                        l_OptGrowth ~ cl_def6_HHI_lag1)

display(Opt_09A)
#Plot residuals versus fitted
stargazer::stargazer(CBre_08B,CBre_09A,
                       Term_08B,Term_09A,
                       Opt_08B,Opt_09A,
                       type="text",
                       digits=2)
...
summary_residual_compare(CBre_08B,CBre_09A,Term_08B,Term_09A)
...
```{r Model09B}
#Frequency Plot for unlogged ceiling
      summary_continuous_plot(def_serv,"def6_ratio_lag1")

      summary_continuous_plot(def_serv,"cl_def6_ratio_lag1")
      


#Scatter Plot
ggplot(serv_opt, aes(x=cl_def6_ratio_lag1, y=l_OptGrowth)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))


#Model
CBre_09B <- glm (data=serv_smp,
...
Opt_09B <- glm(data=serv_opt,
                        l_OptGrowth ~ cl_def6_ratio_lag1)

display(Opt_09B)
#Plot residuals versus fitted
stargazer::stargazer(CBre_08B,CBre_09A,CBre_09B,
                       Term_08B,Term_09A,Term_09B,
                       Opt_08B,Opt_09A,Opt_09B,
                       type="text",
                       digits=2)


summary_residual_compare(CBre_08B,CBre_09B,Term_08A,Term_09A)
summary_residual_compare(CBre_09A,CBre_09B,Term_09A,Term_09B)
...
```{r Model09C}
#Frequency Plot for unlogged ceiling
      summary_continuous_plot(def_serv,"def6_obl_lag1Const")

      summary_continuous_plot(def_serv,"cl_def6_obl_lag1Const")
      


#Scatter Plot
ggplot(serv_opt, aes(x=cl_def6_obl_lag1Const, y=l_OptGrowth)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))


#Model
CBre_09C <- glm (data=serv_smp,
...
Opt_09C <- glm(data=serv_opt,
                        l_OptGrowth ~ cl_def6_obl_lag1Const)

display(Opt_09C)
#Plot residuals versus fitted
stargazer::stargazer(CBre_09A,CBre_09B,CBre_09C,
                       Term_09A,Term_09B,Term_09C,
                       Opt_09A,Opt_09B,Opt_09C,
                       type="text",
                       digits=2)


summary_residual_compare(CBre_08B,CBre_09C,Term_08A,Term_09C)
summary_residual_compare(CBre_09A,CBre_09C,Term_09A,Term_09C)
summary_residual_compare(CBre_09B,CBre_09C,Term_09B,Term_09C)
...
Opt_09D <- glm(data=serv_opt,
                        l_OptGrowth ~ cl_def6_HHI_lag1+cl_def6_ratio_lag1)

glmer_examine(Opt_09D)


CBre_09D2 <- glm (data=serv_smp,
                 b_CBre ~ cl_def6_HHI_lag1+cl_def6_ratio_lag1
                 , family=binomial(link="logit"))
glmer_examine(CBre_09D2)
...
Opt_09D2 <- glm(data=serv_opt,
                        l_OptGrowth ~ cl_def6_HHI_lag1+cl_def6_ratio_lag1)

glmer_examine(Opt_09D2)
#Plot residuals versus fitted
stargazer::stargazer(CBre_09D,CBre_09D2,
                     Term_09D,Term_09D2,
                     Opt_09D,Opt_09D2,
                       type="text",
                       digits=2)

summary_residual_compare(CBre_09D,CBre_09D2,Term_09D,Term_09D2)
```
...
glmer_examine(Opt_09E)

#Plot residuals versus fitted
stargazer::stargazer(CBre_08B,CBre_09D2,CBre_09E,
                     Term_08B,Term_09D2,Term_09E,
                     Opt_08B,Opt_09D2,Opt_09E,
                       type="text",
                       digits=2)

summary_residual_compare(CBre_09D2,CBre_09E,Term_09D2,Term_09E)
summary_residual_compare(CBre_08B,CBre_09E,Term_08B,Term_09E)
```
...
#Scatter Plot
ggplot(serv_opt, aes(x=cl_def3_HHI_lag1, y=l_OptGrowth)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))
...
Opt_10A <- glm(data=serv_opt,
                        l_OptGrowth ~ cl_def3_HHI_lag1)

display(Opt_10A)
#Plot residuals versus fitted
stargazer::stargazer(CBre_09A,CBre_10A,
                       Term_09A,Term_10A,
                       Opt_09A,Opt_10A,
                       type="text",
                       digits=2)

summary_residual_compare(CBre_09A,CBre_10A,Term_09A,Term_10A)
...
Opt_10B <- glm(data=serv_opt,
                        l_OptGrowth ~ cl_def3_ratio_lag1)

display(Opt_10B)
#Plot residuals versus fitted
stargazer::stargazer(CBre_09B,CBre_10A,CBre_10B,
                       Term_09B,Term_10A,Term_10B,
                       Opt_09B,Opt_10A,Opt_10B,
                       type="text",
                       digits=2)

summary_residual_compare(CBre_09B,CBre_10B,Term_09B,Term_10B)
```
...
Opt_10C <- glm(data=serv_opt,
                        l_OptGrowth ~ cl_def3_HHI_lag1+cl_def3_ratio_lag1)

glmer_examine(Opt_10C)
#Plot residuals versus fitted
stargazer::stargazer(CBre_09E,CBre_10A,CBre_10B,CBre_10C,
                     Term_09E,Term_10A,Term_10B,Term_10C,
                     Opt_09E,Opt_10A,Opt_10B,Opt_10C,
                       type="text",
                       digits=2)

summary_residual_compare(CBre_08B,CBre_10C,Term_08B,Term_10C)
```
...
glmer_examine(Opt_10D)

#Plot residuals versus fitted
stargazer::stargazer(CBre_09E,CBre_10C,CBre_10D,
                     Term_09E,Term_10C,Term_10D,
                     Opt_09E,Opt_10C,Opt_10D,
                       type="text",
                       digits=2)

summary_residual_compare(CBre_09D2,CBre_10D,Term_09D2,Term_10D)
summary_residual_compare(CBre_08B,CBre_10D,Term_08B,Term_10D)
```
...
display(Opt_11A)
#Plot residuals versus fitted
stargazer::stargazer(CBre_11A,
                      Term_11A,
                       Opt_11A,
                       type="text",
                       digits=2)

summary_residual_compare(CBre_11A,Term_11A)
...
glmer_examine(Opt_11B)

#Plot residuals versus fitted
stargazer::stargazer(CBre_10D,CBre_11A,CBre_11B,
                     Term_10D,Term_11A,Term_11B,
                     Opt_10D,Opt_11A,Opt_11B,
                       type="text",
                       digits=2)

summary_residual_compare(CBre_10D,CBre_11B,Term_10D,Term_11B)
summary_residual_compare(CBre_11A,CBre_11B,Term_11S,Term_11B)
```
...
Opt_12A <- glm(data=serv_opt,
                        l_OptGrowth ~ cl_OffVol)

display(Opt_12A)

#Plot residuals versus fitted
stargazer::stargazer(CBre_12A,
                       Term_12A,
                       Opt_12A,
                       type="text",
                       digits=2)
...
summary_residual_compare(CBre_11A,CBre_12A,Term_11A,Term_12A, skip_vif = TRUE)
summary_residual_compare(CBre_03D,CBre_12A,Term_03D,Term_12A, skip_vif = TRUE)
...
#Scatter Plot
ggplot(serv_opt, aes(x=cl_hh_index_k, y=l_OptGrowth)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))

#Model
CBre_12B <- glm (data=serv_smp,
                 b_CBre ~ cl_hh_index_k, family=binomial(link="logit"))
display(CBre_12B)
...
Opt_12B <- glm(data=serv_opt,
                        l_OptGrowth ~ cl_hh_index_k)

display(Opt_12B)

#Plot residuals versus fitted
stargazer::stargazer(CBre_12B,
                       Term_12B,
                       Opt_12B,
                       type="text",
                       digits=2)
...
# summary_residual_compare(CBre_11A,CBre_12B,Term_11A,Term_12B, skip_vif = TRUE)
# summary_residual_compare(CBre_03D,CBre_12B,Term_03D,Term_12B, skip_vif = TRUE)
...
CBre_12C <- glm (data=serv_smp,
                 ...
                 c_pairHist+cl_pairCA +
                   ...
                   cl_def3_HHI_lag1+cl_def3_ratio_lag1+
                   c_pMarket+
                   cl_OffVol+cl_hh_index_obl , family=binomial(link="logit"))
...
Opt_12C <- glm(data=serv_opt,
                 ...
                 cl_def3_HHI_lag1+cl_def3_ratio_lag1+
                 c_pMarket+
                   cl_OffVol+cl_hh_index_obl)

glmer_examine(Opt_12C)

#Plot residuals versus fitted
stargazer::stargazer(CBre_11B,CBre_12A,CBre_12C,
                     Term_11B,Term_12A,Term_12C,
                     Opt_11B,Opt_12A,Opt_12C,
                       type="text",
                       digits=2)

summary_residual_compare(CBre_10D,CBre_12C,Term_10D,Term_12C)
summary_residual_compare(CBre_11A,CBre_12C,Term_11S,Term_12C)
```
...
#Ceiling Breaches
  stargazer::stargazer(CBre_01A,CBre_01B,CBre_02A,CBre_02B,CBre_03A,CBre_03B,CBre_03D,CBre_12C,
                       type="text",
                       digits=2)



texreg::htmlreg(list(CBre_01A,CBre_01B,CBre_02A,CBre_02B,CBre_03A,CBre_03B,CBre_03D,CBre_12C),file="..//Output//CBre_model_lvl1.html",
                single.row = TRUE,
                # custom.model.name=c("Ceiling Breaches"),
                stars=c(0.1,0.05,0.01,0.001),
                groups = list(
...
#Exercised Options
stargazer::stargazer(Opt_01A,Opt_01B,Opt_02A,Opt_02B,Opt_03A,Opt_03B,Opt_03D,Opt_12C,
                       type="text",
                       digits=2)


texreg::htmlreg(list(Opt_01A,Opt_01B,Opt_02A,Opt_02B,Opt_03A,Opt_03B,Opt_03D,Opt_12C),file="..//Output//Opt_model_lvl1.html",
                single.row = TRUE,
                # custom.model.name=c("Ceiling Breaches"),
                stars=c(0.1,0.05,0.01,0.001),
                groups = list(

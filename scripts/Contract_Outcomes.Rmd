...
```{r Model11C}
# summary_continuous_plot(serv_smp,"Crisis")
...
#Model
CBre_11C <- glm (data=serv_smp,
                 b_CBre ~ Crisis, family=binomial(link="logit"))
display(CBre_11C)

#Model
Term_11C <- glm (data=serv_smp,
                 b_Term ~ Crisis, family=binomial(link="logit"))
display(Term_11C)

#Model
Opt_11C <- glm (data=serv_smp,
                 l_OptGrowth ~ Crisis)
display(Term_11C)

#Plot residuals versus fitted
  stargazer::stargazer(CBre_11C,Term_11C,Opt_11C, type="text",
                       digits=2)

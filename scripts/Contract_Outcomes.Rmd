...
serv_smp$b_NoComp<-!serv_smp$b_Comp
...
# CBre_02A_curve<-function(x, Comp){invlogit(cbind(1,Comp,x) %*%  coef(CBre_02A))}
# 
# #Competition curves
...
#Plot residuals versus fitted
  stargazer::stargazer(CBre_10A,CBre_NCS6E,CBre_NCS6F,CBre_10C,type="text",
                       digits=2)


summary_residual_compare(CBre_10A,CBre_10C)
...
#### Model 10D: Defense to Overall ratio
The higher the ratio of defense obligations to reciepts in the overall economy, the DoD holds a monosopy over a sector. Given the challenges of monosopy, the a higher ratio estimates a greater  risk of ceiling breaches.
```{r Model10D}
#Frequency Plot for unlogged ceiling
...
#Plot residuals versus fitted
  stargazer::stargazer(CBre_10C,CBre_10D,
                       CBre_01B,CBre_10D,type="text",
                       digits=2)


summary_residual_compare(CBre_10C,CBre_10D)
summary_residual_compare(CBre_10D)
summary_residual_compare(CBre_01B,CBre_10D,bins=2)
summary_residual_compare(CBre_10D,bins=2)
...
#Plot residuals versus fitted
 stargazer::stargazer(CBre_NCS3E,CBre_NCS3F2,CBre_NCS3F4,CBre_NCS6G,CBre_10E3,
                       CBre_NCS3D,CBre_NCS3F2,CBre_NCS3F3,CBre_NCS6G,CBre_10E3,
                       type="text",digits=2)


summary_residual_compare(CBre_NCS3F4,CBre_10E3)
summary_residual_compare(CBre_NCS3F3,CBre_10E3,bins=10)
summary_residual_compare(CBre_NCS3F2,CBre_10E3)
summary_residual_compare(CBre_NCS3F2,CBre_10E3,bins=10)

summary_residual_compare(CBre_NCS3F,CBre_10E3)
summary_residual_compare(CBre_NCS3D,CBre_10E3,bins=10)
summary_residual_compare(CBre_NCS6G,CBre_10E3)
summary_residual_compare(CBre_NCS6G,CBre_10E3,bins=10)

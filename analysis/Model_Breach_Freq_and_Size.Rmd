...
summary_residual_compare(b_CBre12C3, b_cbre_partnership_actions_16B, bins=5)
summary_residual_compare(n_CBre12C3, n_cbre_partnership_actions_16B, bins=5)
```
...
summary_residual_compare(b_cbre_partnership_share_17A_no_interact, b_cbre_partnership_share_17A, bins=5)
...
summary_residual_compare(b_cbre_partnership_actions_16B, b_cbre_partnership_share_17B, bins=5)
summary_residual_compare(n_cbre_partnership_actions_16B, n_cbre_partnership_share_17B2, bins=5)
```
...
summary_residual_compare(b_cbre_partnership_duration_18A_no_interact, b_cbre_partnership_duration_18A, bins=5)
...
summary_residual_compare(b_cbre_partnership_share_17B, b_cbre_partnership_duration_18B, bins=5)
summary_residual_compare(n_cbre_partnership_actions_16B, n_cbre_partnership_duration_18B2, bins=5)
```
...
summary_residual_compare(b_cbre_history_pricing_19A_no_interact, b_cbre_history_pricing_19A, bins=5)
...
summary_residual_compare(b_cbre_partnership_duration_18B, b_cbre_history_pricing_19B, bins=5)
summary_residual_compare(n_cbre_partnership_actions_16B, n_cbre_history_pricing_19B2, bins=5)
```
...
#Compare the Models
stargazer::stargazer(b_CBre_base2ceil_ceiling_21A_no_interac, b_CBre_base2ceil_ceiling_21A, 
                     n_CBre_base2ceil_ceiling_21A_no_interact, n_CBre_base2ceil_ceiling_21A, type="text", digits=2)

summary_residual_compare(b_CBre_base2ceil_ceiling_21A_no_interact, b_CBre_base2ceil_ceiling_21A, bins=5)
...
stargazer::stargazer(b_cbre_partnership_duration_18B, b_CBre_base2ceil_ceiling_21B, 
                     n_cbre_partnership_actions_16B, n_CBre_base2ceil_ceiling_21B,  type="text", digits=2)

summary_residual_compare(b_cbre_partnership_duration_18B, b_CBre_base2ceil_ceiling_21B, bins=5)
summary_residual_compare(n_cbre_partnership_actions_16B, n_CBre_base2ceil_ceiling_21B, bins=5)
```
...
#Compare the Models
stargazer::stargazer(n_CBre_base2ceil_duration_22A_no_interact, n_CBre_base2ceil_duration_22A, b_CBre_base2ceil_duration_22A_no_interact, b_CBre_base2ceil_duration_22A, type="text", digits=2)

#summary_residual_compare(n_CBre_base2ceil_duration_22A_no_interact, n_CBre_base2ceil_duration_22A, b_CBre_base2ceil_duration_22A_no_interact, b_CBre_base2ceil_duration_22A, bins=5)
```
...
b_CBre_base2ceil_duration_22B <- glm(data=serv_smp,
                 ...
                 #cl_office_naics_hhi_k+ 
                                  c_pPBSC:cl_pairCA+c_pPBSC:c_pMarket+
                 c_pPBSC:cl_Days+
                   cl_Base2Ceil:cl_Days, family=binomial(link="logit"))
...
#Compare the models
stargazer::stargazer(b_cbre_partnership_duration_18B, b_CBre_base2ceil_duration_22B, 
                     n_cbre_partnership_actions_16B, n_CBre_base2ceil_duration_22B, type="text", digits=2)

summary_residual_compare(b_cbre_partnership_duration_18B, b_CBre_base2ceil_duration_22B, bins=5)
summary_residual_compare(n_cbre_partnership_actions_16B, n_CBre_base2ceil_duration_22B, bins=5)
```

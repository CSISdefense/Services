...
ggplot(serv_smp, aes(x=cln_US6sal, y=ln_CBre_OMB20_GDP18)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
n_CBre01A <- glm(data=serv_breach,
                        ln_CBre_OMB20_GDP18 ~ cln_US6sal)
...
#Scatter Plot 
ggplot(serv_smp, aes(x=cln_PSCrate, y=ln_CBre_OMB20_GDP18)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
n_CBre01B <- glm(data=serv_breach,
                        ln_CBre_OMB20_GDP18 ~ cln_PSCrate)
...
n_CBre01C <- glm(data=serv_breach,
                        ln_CBre_OMB20_GDP18 ~ cln_US6sal +  cln_PSCrate)
...
#Scatter Plot 
ggplot(serv_smp, aes(x=cp_OffPerf7, y=ln_CBre_OMB20_GDP18)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
n_CBre02A <- glm(data=serv_breach,
                        ln_CBre_OMB20_GDP18 ~ cp_OffPerf7)
...
#Scatter Plot 
ggplot(serv_smp, aes(x=cp_OffPSC7, y=ln_CBre_OMB20_GDP18)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
n_CBre02B <- glm(data=serv_breach,
                        ln_CBre_OMB20_GDP18 ~ cp_OffPSC7)
...
n_CBre02C <- glm(data=serv_breach,
                        ln_CBre_OMB20_GDP18 ~ cp_OffPerf7+cp_OffPSC7)
...
n_CBre02D <- glm(data=serv_breach,
                        ln_CBre_OMB20_GDP18 ~ cln_US6sal + cln_PSCrate+ cp_OffPSC7)
...
#Scatter Plot
ggplot(serv_smp, aes(x=cn_PairHist7, y=ln_CBre_OMB20_GDP18)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
n_CBre03A <- glm(data=serv_breach,
                        ln_CBre_OMB20_GDP18 ~ cn_PairHist7)
...
#Scatter Plot
ggplot(serv_smp, aes(x=cln_PairCA, y=ln_CBre_OMB20_GDP18)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
n_CBre03B <- glm(data=serv_breach,
                        ln_CBre_OMB20_GDP18 ~ cln_PairCA)
...
n_CBre03C <- glm(data=serv_breach,
                        ln_CBre_OMB20_GDP18 ~ cn_PairHist7+cln_PairCA)
...
#Scatter Plot
ggplot(serv_smp, aes(x=cln_Days, y=ln_CBre_OMB20_GDP18)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
#Scatter Plot
ggplot(serv_smp, aes(x=clr_Ceil2Base, y=ln_CBre_OMB20_GDP18)) + geom_point(alpha = 0.1) + ggtitle("Terminations and Ratio Initial Base:Ceiling Ratio (Logged") + theme(plot.title = element_text(hjust = 0.5))
...
n_CBre04C <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ clr_Ceil2Base)
...
n_CBre04D <- glm(data=serv_breach,
                        ln_CBre_OMB20_GDP18 ~cl_Ceil + cln_Days + clr_Ceil2Base)
...
#Scatter Plot
ggplot(serv_smp, aes(x=cln_Base, y=ln_CBre_OMB20_GDP18)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
n_CBre04F <- glm(data=serv_breach,
                        ln_CBre_OMB20_GDP18 ~cln_Base + cln_Days  + clr_Ceil2Base)
...
#Scatter Plot
ggplot(serv_smp, aes(x=Comp, y=ln_CBre_OMB20_GDP18)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
#Scatter Plot
ggplot(serv_smp, aes(x=Pricing, y=ln_CBre_OMB20_GDP18)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
n_CBre09A <- glm(data=serv_breach,
                        ln_CBre_OMB20_GDP18 ~ cln_Def6HHI)
...
#Scatter Plot
ggplot(serv_smp, aes(x=clr_Def6toUS, y=ln_CBre_OMB20_GDP18)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
n_CBre09B <- glm(data=serv_breach,
                        ln_CBre_OMB20_GDP18 ~ clr_Def6toUS)
...
#Likelihood Plot for unlogged ceiling
      ...
      summary_continuous_plot(serv_smp1m,metric="cbre","cln_Def6OblConst")
      


#Scatter Plot
ggplot(serv_smp, aes(x=cln_Def6OblConst, y=ln_CBre_OMB20_GDP18)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))


#Model
b_CBre09C <- glm (data=serv_smp,
                 b_CBre ~ cln_Def6OblConst, family=binomial(link="logit"))


n_CBre09C <- glm(data=serv_breach,
                        ln_CBre_OMB20_GDP18 ~ cln_Def6OblConst)
...
b_CBre09D <- glm (data=serv_smp,
                 b_CBre ~ cln_Def6HHI+clr_Def6toUS+cln_Def6OblConst
                 , family=binomial(link="logit"))
glmer_examine(b_CBre09D)

n_CBre09D <- glm(data=serv_breach,
                        ln_CBre_OMB20_GDP18 ~ cln_Def6HHI+clr_Def6toUS+cln_Def6OblConst)
...
#Scatter Plot
ggplot(serv_smp, aes(x=cln_Def3HHI, y=ln_CBre_OMB20_GDP18)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
n_CBre10A <- glm(data=serv_breach,
                        ln_CBre_OMB20_GDP18 ~ cln_Def3HHI)
...
n_CBre10B <- glm(data=serv_breach,
                        ln_CBre_OMB20_GDP18 ~ clr_Def3toUS)
...
n_CBre10C2 <- glm(data=serv_breach,
                        ln_CBre_OMB20_GDP18 ~ cln_Def6HHI+clr_Def6toUS+
                   cln_Def3HHI+clr_Def3toUS)
...
b_CBre10C3 <- glm (data=serv_smp,
                 b_CBre ~ clr_Def6toUS+cln_Def6OblConst+
                   cln_Def3HHI+clr_Def3toUS, family=binomial(link="logit"))
glmer_examine(b_CBre10C3)

n_CBre10C3 <- glm(data=serv_breach,
                        ln_CBre_OMB20_GDP18 ~ clr_Def6toUS+cln_Def6OblConst+
                   cln_Def3HHI+clr_Def3toUS)
...
#Scatter Plot
ggplot(serv_smp, aes(x=cp_PairObl7, y=ln_CBre_OMB20_GDP18)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
n_CBre11A <- glm(data=serv_breach,
                        ln_CBre_OMB20_GDP18 ~ cp_PairObl7)
...
#Scatter Plot
ggplot(serv_smp, aes(x=cln_OffObl7, y=ln_CBre_OMB20_GDP18)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
n_CBre12A <- glm(data=serv_breach,
                        ln_CBre_OMB20_GDP18 ~ cln_OffObl7)
...
#Scatter Plot
ggplot(serv_smp, aes(x=cln_OffFocus, y=ln_CBre_OMB20_GDP18)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
n_CBre12B <- glm(data=serv_breach,
                        ln_CBre_OMB20_GDP18 ~ cln_OffFocus)
...
n_cbre_salary_pricing_15A_no_interact <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ Pricing + cl_US6_avg_sal_lag1)
glmer_examine(n_cbre_salary_pricing_15A_no_interact)

n_cbre_salary_pricing_15A <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ Pricing + cl_US6_avg_sal_lag1 + Pricing:cl_US6_avg_sal_lag1)
...
n_cbre_salary_pricing_15B <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
n_cbre_partnership_actions_16A_no_interact <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cp_OffPerf7 + cln_PairCA)
glmer_examine(n_cbre_partnership_actions_16A_no_interact)

n_cbre_partnership_actions_16A <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cp_OffPerf7 + cln_PairCA + cp_OffPerf7:cln_PairCA)
...
n_cbre_partnership_actions_16B <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
n_cbre_partnership_share_17A_no_interact <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cp_OffPerf7 + cp_PairObl7)
glmer_examine(n_cbre_partnership_share_17A_no_interact)

n_cbre_partnership_share_17A <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cp_OffPerf7 + cp_PairObl7 + cp_OffPerf7:cp_PairObl7)
...
n_cbre_partnership_share_17B <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
n_cbre_partnership_share_17B2 <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
n_cbre17C_no_interact <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cln_OffObl7 + cp_PairObl7)
glmer_examine(n_cbre17C_no_interact)

n_cbre17C <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cln_OffObl7 + cp_PairObl7 + cln_OffObl7:cp_PairObl7)
...
n_cbre17D <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
n_cbre17D2 <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
n_cbre_partnership_duration_18A_no_interact <- glm(data=serv_breach , ln_CBre_OMB20_GDP18 ~ cp_OffPerf7 + cln_Days)
glmer_examine(n_cbre_partnership_duration_18A_no_interact)

n_cbre_partnership_duration_18A <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cp_OffPerf7 + cln_Days + cp_OffPerf7: cln_Days)
...
n_cbre_partnership_duration_18B <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
n_cbre_partnership_duration_18B2 <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
n_cbre_history_pricing_19A_no_interact <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cn_PairHist7 + Pricing)
glmer_examine(n_cbre_history_pricing_19A_no_interact)

n_cbre_history_pricing_19A <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cn_PairHist7 + Pricing + cn_PairHist7:Pricing)
...
n_cbre_history_pricing_19B <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
n_cbre_history_pricing_19B2 <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
n_cbre_competition_NAICS66_20A_no_interact <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ Comp + cln_Def6HHI)
glmer_examine(n_cbre_competition_NAICS66_20A_no_interact)

n_cbre_competition_NAICS66_20A <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ Comp + cln_Def6HHI + Comp:cln_Def6HHI)
...
n_cbre_competition_NAICS66_20A_no_interact <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ Comp + cln_Def3HHI)
glmer_examine(n_cbre_competition_NAICS66_20A_no_interact)

n_cbre_competition_NAICS66_20A <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ Comp + cln_Def3HHI + Comp:cln_Def3HHI)
glmer_examine(n_cbre_competition_NAICS66_20A)
...
n_cbre_competition_NAICS66_20B <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
n_cbre_competition_NAICS66_20B2 <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
n_cbre_competition_naincs3_20B <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
n_cbre_competition_naincs3_20B2 <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
n_CBre_base2ceil_ceiling_21A_no_interact <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ clr_Ceil2Base + cln_Base)

glmer_examine(n_CBre_base2ceil_ceiling_21A_no_interact)

n_CBre_base2ceil_ceiling_21A <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ clr_Ceil2Base + cln_Base + clr_Ceil2Base:cln_Base)
...
n_CBre_base2ceil_ceiling_21B <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
n_CBre_base2ceil_ceiling_21B2 <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
n_CBre_base2ceil_duration_21C_no_interact <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ clr_Ceil2Base + cln_Days)
glmer_examine(n_CBre_base2ceil_duration_21C_no_interact)

n_CBre_base2ceil_duration_21C <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ clr_Ceil2Base + cln_Days + clr_Ceil2Base:cln_Days)
...
n_CBre_base2ceil_duration_21D <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
n_CBre_base2ceil_duration_21D2 <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
n_cbre_CFTE_pricing_22A_no_interact <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ Pricing + cln_PSCrate)
glmer_examine(n_cbre_CFTE_pricing_22A_no_interact)

n_cbre_CFTE_pricing_22A <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ Pricing + cln_PSCrate + Pricing:cln_PSCrate)
...
n_cbre_CFTE_pricing_22B <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
n_cbre_CFTE_pricing_22B2 <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
```{r Model23A}
#Create the models
b_cbre23A_no_interact <- glm(data=serv_smp, b_CBre ~ pOffPSC + cln_OffObl7, 
                                             family=binomial(link="logit"))
glmer_examine(b_cbre23A_no_interact)

b_cbre23A <- glm(data=serv_smp, b_CBre ~ pOffPSC + cln_OffObl7 + pOffPSC:cln_OffObl7,
                                 family=binomial(link="logit"))
glmer_examine(b_cbre23A)


n_cbre23A_no_interact <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ pOffPSC + cln_OffObl7)
glmer_examine(n_cbre23A_no_interact)

n_cbre23A <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ pOffPSC + cln_OffObl7 + pOffPSC:cln_OffObl7)
...
n_cbre23B <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
n_cbre23B2 <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
```{r Model24B}
#Create the models
b_cbre24B_no_interact <- glm(data=serv_smp, b_CBre ~ pOffPSC + cln_OffFocus, 
                                             family=binomial(link="logit"))
glmer_examine(b_cbre24B_no_interact)

b_cbre24B <- glm(data=serv_smp, b_CBre ~ pOffPSC + cln_OffFocus + pOffPSC:cln_OffFocus,
                                 family=binomial(link="logit"))
...
#Create the model
  ...
  n_CBre25A <- lmer(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cln_US6sal + 
                      cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                      cn_PairHist7+cln_PairCA+
                      cln_Base + clr_Ceil2Base + cln_Days+
                      Comp+
...
if(!exists("n_CBre26A")){
  #Create the model
  n_CBre26A <- lmer(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cln_US6sal + 
                      cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                      cn_PairHist7+cln_PairCA+
                      cln_Base + clr_Ceil2Base + cln_Days+
                      Comp+

...
Dropping PBSC:pairCA for both models. For likelihood it's contrary to expectation and for size the base variables are no longer significant. Also dropping  c_pPBSC:c_pMarketand for likelihood, which is not siginifcant. Keeping base:ratio despite lack of significance because of switching to it for size.
This was created while we were still using ceiling instead of base.

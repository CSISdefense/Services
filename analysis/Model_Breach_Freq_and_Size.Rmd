...
#Compare the models
stargazer::stargazer(b_cbre_salary_pricing_15B, b_CBre12C3, 
                     n_cbre_salary_pricing_15B, n_CBre12C3, type="text", digits=2)

summary_residual_compare(b_cbre_salary_pricing_15B, b_CBre12C3, bins=5)
summary_residual_compare(n_cbre_salary_pricing_15B, n_CBre12C3, bins=5)
...
#Compare the models
stargazer::stargazer(b_cbre_partnership_actions_16B, b_CBre12C3, 
                     n_cbre_partnership_actions_16B, n_CBre12C3,type="text", digits=2)

summary_residual_compare(b_cbre_partnership_actions_16B, b_CBre12C3, bins=5)
summary_residual_compare(n_cbre_partnership_actions_16B, n_CBre12C3, bins=5)
```
...
#Compare the models
stargazer::stargazer(b_cbre_partnership_duration_18B, b_CBre12C3, 
                     n_cbre_partnership_duration_18B, n_CBre12C3,type="text", digits=2)

summary_residual_compare(b_cbre_partnership_duration_18B, b_CBre12C3, bins=5)
summary_residual_compare(n_cbre_partnership_duration_18B, n_CBre12C3, bins=5)
```
...
#Compare the models
stargazer::stargazer(b_cbre_history_pricing_19B, b_CBre12C3, 
                     n_cbre_history_pricing_19B, n_CBre12C3, type="text", digits=2)

summary_residual_compare(b_cbre_history_pricing_19B, b_CBre12C3, bins=5)
summary_residual_compare(n_cbre_history_pricing_19B, n_CBre12C3, bins=5)
```
...
#Compare the models
stargazer::stargazer(b_CBre12C3, b_cbre_competition_naics_20B, 
                     n_CBre12C3, n_cbre_competition_naics_20B, type="text", digits=2)

summary_residual_compare(b_cbre_competition_naics_20B, b_CBre12C3, 
                         n_cbre_competition_naics_20B, n_CBre12C3, 
                         bins=5)
```

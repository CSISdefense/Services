...
```{r Model24D}
#Create the models
b_cbre24D_no_interact <- glm(data=serv_smp, b_CBre ~ cl_OffVol + cl_office_naics_hhi_k, 
                                             family=binomial(link="logit"))
glmer_examine(b_cbre24D_no_interact)

b_cbre24D <- glm(data=serv_smp, b_CBre ~ cl_OffVol + cl_office_naics_hhi_k + cl_OffVol:cl_office_naics_hhi_k,
                                 family=binomial(link="logit"))

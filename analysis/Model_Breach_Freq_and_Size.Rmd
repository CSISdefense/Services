...
stargazer::stargazer(b_cbre_partnership_share_17B, b_cbre_partnership_duration_18B, 
                     n_cbre_partnership_actions_16B, n_cbre_partnership_duration_18B, type="text", digits=2)

summary_residual_compare(b_cbre_partnership_share_17B, b_cbre_partnership_duration_18B, bins=5)
summary_residual_compare(n_cbre_partnership_actions_16B, n_cbre_partnership_duration_18B, bins=5)
```
...
#Compare the models
stargazer::stargazer(b_cbre_partnership_share_17B, b_cbre_history_pricing_19B,
                     n_cbre_partnership_actions_16B, n_cbre_history_pricing_19B, type="text", digits=2)

summary_residual_compare(b_cbre_partnership_share_17B, b_cbre_history_pricing_19B, bins=5)
summary_residual_compare(n_cbre_partnership_actions_16B, n_cbre_history_pricing_19B, bins=5)
```
...
```{r Model20A}
#Create the models
b_cbre_competition_naics_20A_no_interact <- glm(data=serv_smp, b_CBre ~ Comp1or5 + cl_def6_HHI_lag1, family=binomial(link="logit"))
glmer_examine(b_cbre_competition_naics_20A_no_interact)

b_cbre_competition_naics_20A <- glm(data=serv_smp, b_CBre ~ Comp1or5 + cl_def6_HHI_lag1 + Comp1or5:cl_def6_HHI_lag1, family=binomial(link="logit"))
...
#Compare the models
stargazer::stargazer(b_cbre_competition_naics_20A_no_interact, b_cbre_competition_naics_20A, 
                     n_cbre_competition_naics_20A_no_interact, n_cbre_competition_naics_20A, type="text", digits=2)

summary_residual_compare(b_cbre_competition_naics_20A_no_interact, b_cbre_competition_naics_20A, bins=5)
...
```{r Model20B}
#Create the model
b_cbre_competition_naics_20B <- glm(data=serv_smp,
                        b_CBre ~  cl_US6_avg_sal_lag1Const + 
                   cl_CFTE+ c_pPBSC+c_pOffPSC+
                 c_pairHist+cl_pairCA+
                 cl_Base + cl_Base2Ceil + cl_Days+
...
#Compare the models
stargazer::stargazer(b_cbre_partnership_share_17B, b_cbre_competition_naics_20B, 
                     n_cbre_partnership_actions_16B, n_cbre_competition_naics_20B, type="text", digits=2)

summary_residual_compare(b_cbre_partnership_share_17B, b_cbre_competition_naics_20B, 
                         n_cbre_partnership_actions_16B, n_cbre_competition_naics_20B, 
                         bins=5)
```
...
#Compare the models
stargazer::stargazer(b_cbre_partnership_share_17B, b_CBre_base2ceil_ceiling_21B, 
                     n_cbre_partnership_actions_16B, n_CBre_base2ceil_ceiling_21B,  type="text", digits=2)

summary_residual_compare(b_cbre_partnership_share_17B, b_CBre_base2ceil_ceiling_21B, bins=5)
...
#Compare the models
stargazer::stargazer(b_cbre_partnership_share_17B, b_CBre_base2ceil_duration_22B, 
                     n_cbre_partnership_actions_16B, n_CBre_base2ceil_duration_22B, type="text", digits=2)

summary_residual_compare(b_cbre_partnership_share_17B, b_CBre_base2ceil_duration_22B, bins=5)

...
```
For frequency expectations are only partially hold, predominately for other cost based and combination or other. For size, expectations are widely upheld, except UCA contratts which are a special case of cost absed. 
####15B: Cumulative
```{r Model15B}
#Create the model
b_cbre_salary_pricing_15B <- glm(data=serv_breach,
                        b_CBre ~  cl_US6_avg_sal_lag1Const + 
                   cl_CFTE+ c_pPBSC+c_pOffPSC+
                 c_pairHist+cl_pairCA+
                 cl_Base + cl_Base2Ceil + cl_Days+
...
#Compare the models
stargazer::stargazer(b_cbre_salary_pricing_15B, b_CBre12C3, n_cbre_salary_pricing_15B, n_CBre12C3, type="text", digits=2)

summary_residual_compare(b_cbre_salary_pricing_15B, b_CBre12C3, n_cbre_salary_pricing_15B, n_CBre12C3, bins=5)
...
b_cbre_partnership_actions_16A_no_interact <- glm(data=serv_breach, b_CBre ~ c_pPBSC + cl_pairCA, family=binomial(link="logit"))
glmer_examine(b_cbre_partnership_actions_16A_no_interact)

b_cbre_partnership_actions_16A <- glm(data=serv_breach, b_CBre ~ c_pPBSC + cl_pairCA + c_pPBSC:cl_pairCA, family=binomial(link="logit"))
glmer_examine(b_cbre_partnership_actions_16A)


#compare the models

stargazer::stargazer(n_cbre_partnership_actions_16A_no_interact, n_cbre_partnership_actions_16A, b_cbre_partnership_actions_16A_no_interact, b_cbre_partnership_actions_16A, type="text", digits=2)

#summary_residual_compare(n_cbre_partnership_actions_16A_no_interact, n_cbre_partnership_actions_16A, b_cbre_partnership_actions_16A_no_interact, b_cbre_partnership_actions_16A, bins=3)
...
b_cbre_partnership_actions_16B <- glm(data=serv_breach,
                        b_CBre ~  cl_US6_avg_sal_lag1Const + 
                   cl_CFTE+ c_pPBSC+c_pOffPSC+
                 c_pairHist+cl_pairCA+
                 cl_Base + cl_Base2Ceil + cl_Days+
...
#Compare the models
stargazer::stargazer(n_cbre_partnership_actions_16B, n_CBre12C3,b_cbre_partnership_actions_16B, b_CBre12C3, type="text", digits=2)

#summary_residual_compare(n_cbre_partnership_actions_16B, n_CBre12C3, b_cbre_partnership_actions_16B, b_CBre12C3, bins=5)
```
...
b_cbre_partnership_share_17A_no_interact <- glm(data=serv_breach, b_CBre ~ c_pPBSC + c_pMarket, family=binomial(link="logit"))
glmer_examine(b_cbre_partnership_share_17A_no_interact)

b_cbre_partnership_share_17A <- glm(data=serv_breach, b_CBre ~ c_pPBSC + c_pMarket + c_pPBSC:c_pMarket, family=binomial(link="logit"))
glmer_examine(b_cbre_partnership_share_17A)

#Compare the models
stargazer::stargazer(n_cbre_partnership_share_17A_no_interact, n_cbre_partnership_share_17A, b_cbre_partnership_share_17A_no_interact, b_cbre_partnership_share_17A, type="text", digits=2)

#summary_residual_compare(n_cbre_partnership_share_17A_no_interact, n_cbre_partnership_share_17A, b_cbre_partnership_share_17A_no_interact, b_cbre_partnership_share_17A, bins=5)
```

####17B: Cumulative
```{r Model17B}
#Create the model
b_cbre_partnership_share_17B <- glm(data=serv_breach,
                        b_CBre ~  cl_US6_avg_sal_lag1Const + 
                   cl_CFTE+ c_pPBSC+c_pOffPSC+
                 c_pairHist+cl_pairCA+
                 cl_Base + cl_Base2Ceil + cl_Days+
...
#Compare the models
stargazer::stargazer(n_cbre_partnership_share_17B, n_CBre12C3, b_cbre_partnership_share_17B, b_CBre12C3, type="text", digits=2)

#summary_residual_compare(n_cbre_partnership_share_17B, n_CBre12C3, b_cbre_partnership_share_17B, b_CBre12C3, bins=5)
```
...
```{r Model18A}
#Create the Model
n_cbre_partnership_duration_18A_no_interact <- glm(data=serv_smp , ln_CBre_OMB20_GDP18 ~ c_pPBSC + cl_Days)
...
b_cbre_partnership_duration_18A <- glm(data=serv_breach, b_CBre ~ c_pPBSC + cl_Days + c_pPBSC: cl_Days, family=binomial(link="logit"))
glmer_examine(b_cbre_partnership_duration_18A)

#Compare the models
stargazer::stargazer(n_cbre_partnership_duration_18A_no_interact, n_cbre_partnership_duration_18A, b_cbre_partnership_duration_18A_no_interact, b_cbre_partnership_duration_18A, type="text", digits=2)

#summary_residual_compare(n_cbre_partnership_duration_18A_no_interact, n_cbre_partnership_duration_18A, b_cbre_partnership_duration_18A_no_interact, b_cbre_partnership_duration_18A, bins=5)
```

####18B: Cumulative
```{r Model18B}
#Create the model
b_cbre_partnership_duration_18B <- glm(data=serv_breach,
                        b_CBre ~  cl_US6_avg_sal_lag1Const + 
                   cl_CFTE+ c_pPBSC+c_pOffPSC+
                 c_pairHist+cl_pairCA+
                 cl_Base + cl_Base2Ceil + cl_Days+
...
#Compare the models
stargazer::stargazer(n_cbre_partnership_duration_18B, n_CBre12C3, b_cbre_partnership_duration_18B, b_CBre12C3, type="text", digits=2)

#summary_residual_compare(n_cbre_partnership_duration_18B, n_CBre12C3, b_cbre_partnership_duration_18B, b_CBre12C3, bins=5)
```
...
b_cbre_history_pricing_19A_no_interact <- glm(data=serv_breach, b_CBre ~ c_pairHist + PricingUCA, family=binomial(link="logit"))
glmer_examine(b_cbre_history_pricing_19A_no_interact)

b_cbre_history_pricing_19A <- glm(data=serv_breach, b_CBre ~ c_pairHist + PricingUCA + c_pairHist:PricingUCA, family=binomial(link="logit"))
glmer_examine(b_cbre_history_pricing_19A)

#Compare the models
stargazer::stargazer(n_cbre_history_pricing_19A_no_interact, n_cbre_history_pricing_19A, b_cbre_history_pricing_19A_no_interact, b_cbre_history_pricing_19A, type="text", digits=2)

#summary_residual_compare(n_cbre_history_pricing_19A_no_interact, n_cbre_history_pricing_19A, b_cbre_history_pricing_19A_no_interact, b_cbre_history_pricing_19A, bins=5)
```

####19B: Cumulative
```{r Model19B}
#Create the model
b_cbre_history_pricing_19B <- glm(data=serv_breach,
                        b_CBre ~  cl_US6_avg_sal_lag1Const + 
                   cl_CFTE+ c_pPBSC+c_pOffPSC+
                 c_pairHist+cl_pairCA+
                 cl_Base + cl_Base2Ceil + cl_Days+
...
#Compare the models
stargazer::stargazer(n_cbre_history_pricing_19B, n_CBre12C3, b_cbre_history_pricing_19B, b_CBre12C3, type="text", digits=2)

#summary_residual_compare(n_cbre_history_pricing_19B, n_CBre12C3, b_cbre_history_pricing_19B, b_CBre12C3, bins=5)
```
...
b_cbre_competition_naics_20A_no_interact <- glm(data=serv_breach, b_CBre ~ Comp1or5 + cl_def6_HHI_lag1, family=binomial(link="logit"))
glmer_examine(b_cbre_competition_naics_20A_no_interact)

b_cbre_competition_naics_20A <- glm(data=serv_breach, b_CBre ~ Comp1or5 + cl_def6_HHI_lag1 + Comp1or5:cl_def6_HHI_lag1, family=binomial(link="logit"))
glmer_examine(b_cbre_competition_naics_20A)

#Compare the models
stargazer::stargazer(n_cbre_competition_naics_20A_no_interact, n_cbre_competition_naics_20A, b_cbre_competition_naics_20A_no_interact, b_cbre_competition_naics_20A, type="text", digits=2)

#summary_residual_compare(n_cbre_competition_naics_20A_no_interact, n_cbre_competition_naics_20A, b_cbre_competition_naics_20A_no_interact, b_cbre_competition_naics_20A, bins=5)
```

####20B: Cumulative
```{r Model20B}
#Create the model
b_cbre_competition_naics_20B <- glm(data=serv_breach,
                        b_CBre ~  cl_US6_avg_sal_lag1Const + 
                   cl_CFTE+ c_pPBSC+c_pOffPSC+
                 c_pairHist+cl_pairCA+
                 cl_Base + cl_Base2Ceil + cl_Days+
...
#Compare the models
stargazer::stargazer(n_cbre_competition_naics_20B, n_CBre12C3, b_cbre_competition_naics_20B, b_CBre12C3, type="text", digits=2)

#summary_residual_compare(n_cbre_competition_naics_20B, n_CBre12C3, b_cbre_competition_naics_20B, b_CBre12C3, bins=5)
```
...
b_CBre_base2ceil_ceiling_21A_no_interact <- glm(data=serv_breach,b_CBre ~ cl_Base2Ceil + cl_Base, family=binomial(link="logit"))
glmer_examine(b_CBre_base2ceil_ceiling_21A_no_interact)

b_CBre_base2ceil_ceiling_21A <- glm(data=serv_breach, b_CBre ~ cl_Base2Ceil + cl_Base + cl_Base2Ceil:cl_Base, family=binomial(link="logit"))
glmer_examine(b_CBre_base2ceil_ceiling_21A)

#Compare the Models
stargazer::stargazer(n_CBre_base2ceil_ceiling_21A_no_interact, n_CBre_base2ceil_ceiling_21A, b_CBre_base2ceil_ceiling_21A_no_interac, b_CBre_base2ceil_ceiling_21A, type="text", digits=2)

#summary_residual_compare(n_CBre_base2ceil_ceiling_21A_no_interact, n_CBre_base2ceil_ceiling_21A, b_CBre_base2ceil_ceiling_21A_no_interact, b_CBre_base2ceil_ceiling_21A, bins=5)
```

####21B: Cumulative
```{r Model21B}
#Create the model
b_CBre_base2ceil_ceiling_21B <- glm(data=serv_breach,
                        b_CBre ~  cl_US6_avg_sal_lag1Const + 
                   cl_CFTE+ c_pPBSC+c_pOffPSC+
                 c_pairHist+cl_pairCA+
                 cl_Base + cl_Base2Ceil + cl_Days+
...
n_CBre_base2ceil_ceiling_21B <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cl_US6_avg_sal_lag1Const + 
                 ...
                 Comp1or5+
                   ...
                   cl_def3_HHI_lag1+cl_def3_ratio_lag1+
                   c_pMarket+
                   cl_OffVol+cl_office_naics_hhi_k + cl_Base2Ceil:cl_Base)
...
#Compare the models
stargazer::stargazer(n_CBre_base2ceil_ceiling_21B, n_CBre12C3, b_CBre_base2ceil_ceiling_21B, b_CBre12C3, type="text", digits=2)

#summary_residual_compare(n_CBre_base2ceil_ceiling_21B, n_CBre12C3, b_CBre_base2ceil_ceiling_21B, b_CBre12C3, bins=5)
```
...
b_CBre_base2ceil_duration_22A_no_interact <- glm(data=serv_breach, b_CBre ~ cl_Base2Ceil + cl_Days, family=binomial(link="logit"))
glmer_examine(b_CBre_base2ceil_duration_22A_no_interact)

b_CBre_base2ceil_duration_22A <- glm(data=serv_breach, b_CBre ~ cl_Base2Ceil + cl_Days + cl_Base2Ceil:cl_Days, family=binomial(link="logit"))
...
```{r Model22B}
#Create the model
b_CBre_base2ceil_duration_22B <- glm(data=serv_breach,
                        b_CBre ~  cl_US6_avg_sal_lag1Const + 
                   cl_CFTE+ c_pPBSC+c_pOffPSC+
                 c_pairHist+cl_pairCA+
                 cl_Base + cl_Base2Ceil + cl_Days+
...
#Compare the models
stargazer::stargazer(n_CBre_base2ceil_duration_22B, n_CBre12C3, b_CBre_base2ceil_duration_22B, b_CBre12C3, type="text", digits=2)

#summary_residual_compare(n_CBre_base2ceil_duration_22B, n_CBre12C3, b_CBre_base2ceil_duration_22B, b_CBre12C3, bins=5)
```

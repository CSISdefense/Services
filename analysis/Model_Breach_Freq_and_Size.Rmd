...
#Plot residuals versus fitted
#stargazer::stargazer(b_CBre08B, b_CBre09A, n_CBre08B,n_CBre09A, type="text",digits=2)
stargazer::stargazer(b_CBre09A, n_CBre09A, type="text",digits=2)
...
#Plot residuals versus fitted
#stargazer::stargazer(b_CBre08B,b_CBre09A,b_CBre09B,n_CBre08B,n_CBre09A,n_CBre09B,type="text",digits=2)

stargazer::stargazer(b_CBre09A,b_CBre09B,n_CBre09A,n_CBre09B,type="text",digits=2)
...
#Plot residuals versus fitted
stargazer::stargazer(b_CBre09A,b_CBre09B,b_CBre09C,n_CBre09A,n_CBre09B,n_CBre09C,type="text",digits=2)
...
#Plot residuals versus fitted
#stargazer::stargazer(b_CBre08B,b_CBre09D,b_CBre09E,n_CBre08B,n_CBre09D,n_CBre09E,type="text",digits=2)
stargazer::stargazer(b_CBre09D,b_CBre09E,n_CBre09D,n_CBre09E,type="text",digits=2)
...
```
Detailed Industry Focus unfortunately runs into VIF problems wit office PBSC for the breach size model. Keeping breach size does not always align with expectations, but is  significant, is a study variable and has a lower AIC, so keeping it.
...
n_CBre_base2ceil_duration_22B <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cl_US6_avg_sal_lag1Const + 
                 ...
                 c_pairHist+cl_pairCA +
                   ...
                   cl_def3_HHI_lag1+cl_def3_ratio_lag1+
                   c_pMarket+
                   cl_OffVol+cl_office_naics_hhi_k + cl_Base2Ceil:cl_Days)

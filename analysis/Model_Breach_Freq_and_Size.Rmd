...
save(b_CBre25A,n_CBre25A,file="..\\output\\CBre25A")
...
####25B: 2019-08-20 Switch to base and 1m sample.
```{r Term26A}
#Create the model
term26A <- glmer(data=serv_smp1m, b_Term ~ cl_US6_avg_sal_lag1Const + 
                   cl_CFTE+ c_pPBSC+c_pOffPSC+
                 c_pairHist+cl_pairCA +
                 ...
                 family=binomial(link="logit"),
               verbose=TRUE)
glmer_examine(term26A,display = TRUE)
display(term26A)
save(term26A,file="..\\output\\term26A.rdata")

#Compare the models
stargazer::stargazer(term_base2ceil_ceiling_21B, term26A, type="text", digits=2)

summary_residual_compare( term_base2ceil_ceiling_21B, term26A,bins=100)
```
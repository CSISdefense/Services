...
serv_smp$ln_CBre<-serv_smp$ln_CBre_OMB20_GDP18
serv_smp1m$ln_CBre<-serv_smp1m$ln_CBre_OMB20_GDP18
serv_breach$ln_CBre<-serv_breach$ln_CBre_OMB20_GDP18
...
#Scatter Plot
ggplot(serv_smp, aes(x=cln_Def6OblConst, y=ln_CBre)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
n_CBre09D <- glm(data=serv_breach,
                        ln_CBre ~ cln_Def6HHI+clr_Def6toUS+cln_Def6OblConst)
...
n_CBre10C3 <- glm(data=serv_breach,
                        ln_CBre ~ clr_Def6toUS+cln_Def6OblConst+
                   cln_Def3HHI+clr_Def3toUS)
...
n_cbre23A_no_interact <- glm(data=serv_breach, ln_CBre ~ pOffPSC + cln_OffObl7)
glmer_examine(n_cbre23A_no_interact)

n_cbre23A <- glm(data=serv_breach, ln_CBre ~ pOffPSC + cln_OffObl7 + pOffPSC:cln_OffObl7)

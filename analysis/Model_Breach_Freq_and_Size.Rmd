...
++	-	-
```{r Model21C}
b_CBre_base2ceil_duration_21C_no_interact <- glm(data=serv_smp, b_CBre ~ cl_Base2Ceil + cl_Days, family=binomial(link="logit"))
glmer_examine(b_CBre_base2ceil_duration_21C_no_interact)

b_CBre_base2ceil_duration_21C <- glm(data=serv_smp, b_CBre ~ cl_Base2Ceil + cl_Days + cl_Base2Ceil:cl_Days, family=binomial(link="logit"))
glmer_examine(b_CBre_base2ceil_duration_21C)

n_CBre_base2ceil_duration_21C_no_interact <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cl_Base2Ceil + cl_Days)
glmer_examine(n_CBre_base2ceil_duration_21C_no_interact)

n_CBre_base2ceil_duration_21C <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cl_Base2Ceil + cl_Days + cl_Base2Ceil:cl_Days)
...
n_CBre_base2ceil_duration_21D <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cl_US6_avg_sal_lag1Const + 
                   cl_CFTE+ c_pPBSC+c_pOffPSC+
                 c_pairHist+cl_pairCA+
                 cl_Base + cl_Base2Ceil + cl_Days+
                 Comp1or5+
...
n_CBre_base2ceil_duration_21D2 <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cl_US6_avg_sal_lag1Const + 
                   cl_CFTE+ c_pPBSC+c_pOffPSC+
                 c_pairHist+cl_pairCA+
                 cl_Base + cl_Base2Ceil + cl_Days+
                 Comp1or5+
...
```{r Model22A}
#Create the models
b_cbre_CFTE_pricing_22A_no_interact <- glm(data=serv_smp, b_CBre ~ PricingUCA + cl_CFTE, 
                                             family=binomial(link="logit"))
glmer_examine(b_cbre_CFTE_pricing_22A_no_interact)

b_cbre_CFTE_pricing_22A <- glm(data=serv_smp, b_CBre ~ PricingUCA + cl_CFTE + PricingUCA:cl_CFTE,
                                 family=binomial(link="logit"))
glmer_examine(b_cbre_CFTE_pricing_22A)


n_cbre_CFTE_pricing_22A_no_interact <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ PricingUCA + cl_CFTE)
glmer_examine(n_cbre_CFTE_pricing_22A_no_interact)

n_cbre_CFTE_pricing_22A <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ PricingUCA + cl_CFTE + PricingUCA:cl_CFTE)
...
n_cbre_CFTE_pricing_22B <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cl_US6_avg_sal_lag1Const + 
                   cl_CFTE+ c_pPBSC+c_pOffPSC+
                 c_pairHist+cl_pairCA+
                 cl_Base + cl_Base2Ceil + cl_Days+
                 Comp1or5+
...
n_cbre_CFTE_pricing_22B2 <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cl_US6_avg_sal_lag1Const + 
                   cl_CFTE+ c_pPBSC+c_pOffPSC+
                 c_pairHist+cl_pairCA+
                 cl_Base + cl_Base2Ceil + cl_Days+
                 Comp1or5+
...
```{r Model23A}
#Create the models
b_cbre23A_no_interact <- glm(data=serv_smp, b_CBre ~ pOffPSC + cl_OffVol, 
                                             family=binomial(link="logit"))
glmer_examine(b_cbre23A_no_interact)

b_cbre23A <- glm(data=serv_smp, b_CBre ~ pOffPSC + cl_OffVol + pOffPSC:cl_OffVol,
                                 family=binomial(link="logit"))
glmer_examine(b_cbre23A)


n_cbre23A_no_interact <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ pOffPSC + cl_OffVol)
glmer_examine(n_cbre23A_no_interact)

n_cbre23A <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ pOffPSC + cl_OffVol + pOffPSC:cl_OffVol)
...
b_cbre23B <- glm(data=serv_smp,
                 ...
                 c_pPBSC:cl_Days+
                   cl_Base2Ceil:cl_Base+
                 PricingUCA:cl_CFTE+
                   pOffPSC:cl_OffVol, family=binomial(link="logit"))
glmer_examine(b_cbre23B)

n_cbre23B <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cl_US6_avg_sal_lag1Const + 
                   cl_CFTE+ c_pPBSC+c_pOffPSC+
                 c_pairHist+cl_pairCA+
                 cl_Base + cl_Base2Ceil + cl_Days+
                 Comp1or5+
...
n_cbre23B2 <- glm(data=serv_breach, ln_CBre_OMB20_GDP18 ~ cl_US6_avg_sal_lag1Const + 
                   cl_CFTE+ c_pPBSC+c_pOffPSC+
                 c_pairHist+cl_pairCA+
                 cl_Base + cl_Base2Ceil + cl_Days+
                 Comp1or5+
...
summary_residual_compare(n_cbre_partnership_actions_16B, n_cbre22B)
...
####24A: Restoring cl_def3_HHI_lag1 and cl_office_naics_hhi_k
```{r Model24A}
#Create the model
b_cbre24A <- glm(data=serv_smp,
                        b_CBre ~  cl_US6_avg_sal_lag1Const + 
                   cl_CFTE+ c_pPBSC+c_pOffPSC+
                 c_pairHist+cl_pairCA+
                 cl_Base + cl_Base2Ceil + cl_Days+
...
```{r Model24B}
#Create the models
b_cbre24B_no_interact <- glm(data=serv_smp, b_CBre ~ pOffPSC + cl_office_naics_hhi_k, 
                                             family=binomial(link="logit"))
glmer_examine(b_cbre24B_no_interact)

b_cbre24B <- glm(data=serv_smp, b_CBre ~ pOffPSC + cl_office_naics_hhi_k + pOffPSC:cl_office_naics_hhi_k,
                                 family=binomial(link="logit"))
...
stargazer::stargazer(b_cbre24B_no_interact, b_cbre24B, 
                     type="text", digits=2)


summary_residual_compare(b_cbre24B_no_interact, b_cbre24B, bins=5)
...
b_cbre24C <- glm(data=serv_smp,
                 ...
                 c_pPBSC:cl_Days+
                   cl_Base2Ceil:cl_Base+
                 PricingUCA:cl_CFTE+
                   pOffPSC:cl_office_naics_hhi_k, family=binomial(link="logit"))
glmer_examine(b_cbre24C)



#Compare the models
  stargazer::stargazer(b_cbre_CFTE_pricing_22B, b_cbre24C, type="text", digits=2)

summary_residual_compare(b_cbre_CFTE_pricing_22B, b_cbre24C)

...
summary_residual_compare(b_CBre01A,skip_vif = TRUE)
...
summary_residual_compare(b_CBre01B, skip_vif = TRUE)
...
stargazer::stargazer(b_CBre01A,b_CBre01B,b_CBre01C,
  ...
  summary_residual_compare(b_CBre01C, skip_vif = TRUE)
...
summary_residual_compare(b_CBre09D,b_CBre09D22)
```
...
summary_residual_compare(b_CBre11A, skip_vif =  TRUE)
...
#Scatter Plot
ggplot(serv_smp, aes(x=cl_hh_index_k, y=ln_CBre)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))

...
ggplot(serv_smp, aes(x=cl_US6_avg_sal_lag1Const, y=ln_CBre)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))
...
stargazer::stargazer(b_CBre01A,Term_01A,n_CBre01A,type="text",
                       digits=2)


summary_residual_compare(b_CBre01A,Term_01A,skip_vif = TRUE)
...
#Scatter Plot 
ggplot(serv_smp, aes(x=cl_CFTE, y=ln_CBre)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))
...
summary_residual_compare(b_CBre01B,Term_01B, skip_vif = TRUE)
summary_residual_compare(b_CBre01A,b_CBre01B,Term_01A,Term_01B, skip_vif = TRUE)
...
stargazer::stargazer(b_CBre01A,b_CBre01B,b_CBre01C,
  ...
  summary_residual_compare(b_CBre01C,Term_01C, skip_vif = TRUE)
  summary_residual_compare(b_CBre01A,b_CBre01C,Term_01A,Term_01C)
  summary_residual_compare(b_CBre01B,b_CBre01C,Term_01B,Term_01C)
...
#Scatter Plot 
ggplot(serv_smp, aes(x=c_pPBSC, y=ln_CBre)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))
...
#Scatter Plot 
ggplot(serv_smp, aes(x=c_pOffPSC, y=ln_CBre)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))
...
summary_residual_compare(b_CBre02A,b_CBre02B,Term_02A,Term_02B, skip_vif = TRUE)
...
summary_residual_compare(b_CBre02A,b_CBre02C,Term_02A,Term_02C)
summary_residual_compare(b_CBre02B,b_CBre02C,Term_02B,Term_02C)
...
summary_residual_compare(b_CBre02C,b_CBre02D,Term_02C,Term_02D)
summary_residual_compare(b_CBre01C,b_CBre02D,Term_01C,Term_02D)
...
#Scatter Plot
ggplot(serv_smp, aes(x=c_pairHist, y=ln_CBre)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))
...
summary_residual_compare(b_CBre02D,b_CBre03A,Term_02D,Term_03A, skip_vif = TRUE)
...
#Scatter Plot
ggplot(serv_smp, aes(x=cl_pairCA, y=ln_CBre)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))
...
summary_residual_compare(b_CBre03A,b_CBre03B,Term_03A,Term_03B, skip_vif = TRUE)
summary_residual_compare(b_CBre02D,b_CBre03B,Term_02D,Term_03B, skip_vif = TRUE)
...
summary_residual_compare(b_CBre03A,b_CBre03C,Term_03A,Term_03C)
summary_residual_compare(b_CBre03B,b_CBre03C,Term_03B,Term_03C)
summary_residual_compare(b_CBre02D,b_CBre03C,Term_02D,Term_03C)
...
summary_residual_compare(b_CBre03C,b_CBre03D,Term_03C,Term_03D)
summary_residual_compare(b_CBre02D,b_CBre03D,Term_02D,Term_03D)
...
#Scatter Plot
ggplot(serv_smp, aes(x=cl_Ceil, y=ln_CBre)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))
...
#summary_residual_compare(b_CBre03D,b_CBre04A,Term_03D,Term_04A, skip_vif = TRUE)
...
#Scatter Plot
ggplot(serv_smp, aes(x=capped_cl_Days, y=ln_CBre)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))
...
summary_residual_compare(b_CBre03D,b_CBre04B,Term_03D,Term_04B, skip_vif = TRUE)
summary_residual_compare(b_CBre04A,b_CBre04B,Term_04A,Term_04B, skip_vif = TRUE)
...
#summary_residual_compare(b_CBre03D,b_CBre04C,Term_03D,Term_04C)
#summary_residual_compare(b_CBre04A,b_CBre04C,Term_04A,Term_04C)
#summary_residual_compare(b_CBre04B,b_CBre04C,Term_04B,Term_04C)
...
#summary_residual_compare(b_CBre03D,b_CBre04D,Term_03D,Term_04D)
#summary_residual_compare(b_CBre04C,b_CBre04D,Term_04C,Term_04D)
...
#Scatter Plot
ggplot(serv_smp, aes(x=Comp1or5, y=ln_CBre)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))
...
#summary_residual_compare(b_CBre04D,b_CBre05B,Term_04D,Term_05B)
...
#Scatter Plot
ggplot(serv_smp, aes(x=Veh, y=ln_CBre)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))
...
#summary_residual_compare(b_CBre05D,b_CBre06A,Term_05D,Term_06A)
...
#summary_residual_compare(b_CBre05B,b_CBre06B,Term_05B,Term_06B)
...
#Scatter Plot
ggplot(serv_smp, aes(x=PricingUCA, y=ln_CBre)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))
...
#summary_residual_compare(b_CBre06B,b_CBre07A,Term_06B,Term_07A,30)
...
#summary_residual_compare(b_CBre06B,b_CBre07B,Term_06B,Term_07B)
#summary_residual_compare(b_CBre07A,b_CBre07B,Term_07A,Term_07B,bins=3)
...
#Scatter Plot
ggplot(serv_smp, aes(x=Crisis, y=ln_CBre)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))
...
# summary_residual_compare(b_CBre07B,b_CBre08A,Term_07B,Term_08A,30)
...
#summary_residual_compare(b_CBre07B,b_CBre08B,Term_07B,Term_08B)
...
#Scatter Plot
ggplot(serv_smp, aes(x=cl_def6_HHI_lag1, y=ln_CBre)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))
...
summary_residual_compare(b_CBre08B,b_CBre09A,Term_08B,Term_09A, skip_vif = TRUE)
...
#Scatter Plot
ggplot(serv_smp, aes(x=cl_def6_ratio_lag1, y=ln_CBre)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))
...
#summary_residual_compare(b_CBre08B,b_CBre09B,Term_08A,Term_09A)
#summary_residual_compare(b_CBre09A,b_CBre09B,Term_09A,Term_09B)
...
#Scatter Plot
ggplot(serv_smp, aes(x=cl_def6_obl_lag1Const, y=ln_CBre)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))
...
#summary_residual_compare(b_CBre08B,b_CBre09C,Term_08A,Term_09C)
#summary_residual_compare(b_CBre09A,b_CBre09C,Term_09A,Term_09C)
#summary_residual_compare(b_CBre09B,b_CBre09C,Term_09B,Term_09C)
...
summary_residual_compare(b_CBre09D,b_CBre09D2,Term_09D,Term_09D2)
```
...
#summary_residual_compare(b_CBre09D2,b_CBre09E,Term_09D2,Term_09E)
#summary_residual_compare(b_CBre08B,b_CBre09E,Term_08B,Term_09E)
```
...
#Scatter Plot
ggplot(serv_smp, aes(x=cl_def3_HHI_lag1, y=ln_CBre)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))
...
summary_residual_compare(b_CBre09A,b_CBre10A,Term_09A,Term_10A, skip_vif =  TRUE)
...
summary_residual_compare(b_CBre09B,b_CBre10B,Term_09B,Term_10B, skip_vif = TRUE)
```
...
summary_residual_compare(b_CBre08B,b_CBre10C,Term_08B,Term_10C)
```
...
summary_residual_compare(b_CBre09D2,b_CBre10D,Term_09D2,Term_10D)
summary_residual_compare(b_CBre08B,b_CBre10D,Term_08B,Term_10D)
```
...
#Scatter Plot
ggplot(serv_smp, aes(x=c_pMarket, y=ln_CBre)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))
...
summary_residual_compare(b_CBre11A,Term_11A, skip_vif =  TRUE)
...
#summary_residual_compare(b_CBre10D,b_CBre11B,Term_10D,Term_11B)
#summary_residual_compare(b_CBre11A,b_CBre11B,Term_11S,Term_11B)
```
...
#Scatter Plot
ggplot(serv_smp, aes(x=cl_OffVol, y=ln_CBre)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))
...
summary_residual_compare(b_CBre11A,b_CBre12A,Term_11A,Term_12A, skip_vif = TRUE)
summary_residual_compare(b_CBre03D,b_CBre12A,Term_03D,Term_12A, skip_vif = TRUE)
...
#Scatter Plot
ggplot(serv_smp, aes(x=cl_hh_index_k, y=ln_CBre)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))
...
# summary_residual_compare(b_CBre11A,b_CBre12B,Term_11A,Term_12B, skip_vif = TRUE)
# summary_residual_compare(b_CBre03D,b_CBre12B,Term_03D,Term_12B, skip_vif = TRUE)
...
summary_residual_compare(b_CBre10D,b_CBre12C,Term_10D,Term_12C)
summary_residual_compare(b_CBre11A,b_CBre12C,Term_11S,Term_12C)
```

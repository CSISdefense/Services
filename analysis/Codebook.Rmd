...
Agency_Summary<-read_and_join_experiment(Agency_Summary,
...
Agency_Summary$Agency <- factor(Agency_Summary$Agency, levels = rev(Agency_Summary$Agency))
Agency_Summary <- Agency_Summary[order(-Agency_Summary$Percent_Freq),]
Agency_Summary$Agency_Description <- factor(Agency_Summary$Agency_Description, 
                                         levels=rev(Agency_Summary$Agency_Description))
...
Percent_Obli <- c()
for (i in Agency_Summary$Agency) {
...
Agency_Summary$Percent_Obli <- Percent_Obli*100

#Get top 5 Agencies that take largest percent obligation
Agency_Summary <- Agency_Summary[order(-Percent_Obli),]
Agency_Summary <- Agency_Summary[1:5,]
percent_freq_rest <- 100 - sum(Agency_Summary$Percent_Freq, na.rm = TRUE)
percent_obli_rest <- 100 - sum(Agency_Summary$Percent_Obli, na.rm = TRUE)

Agency_Summary[6,] <- c("All Other", "NA", percent_freq_rest, "All Other", percent_obli_rest)
Agency_Summary$Agency_Description <- factor(Agency_Summary$Agency_Description, levels = rev(Agency_Summary$Agency_Description))
Agency_Summary[,c(3,5)] <- lapply(Agency_Summary[,c(3,5)], function(x) as.numeric(x))
Agency_Summary <- melt(Agency_Summary, id = c("Agency","Count_Freq","Percent_Freq", "Agency_Description"))

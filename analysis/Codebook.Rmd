...
freq_continuous_plot(def_serv,"office_psc_obligatedamount_7year",bins=100)
freq_continuous_plot(def_serv,"office_psc_obligatedamount_7year",bins=100, log=TRUE)  #No real point here either

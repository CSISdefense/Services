...
freq_continuous_plot(def_serv,"office_obligatedamount_1year",bins=50, log=TRUE , plus1 = TRUE)
```
...
loggedplus1<-statsummary_continuous(c("office_obligatedamount_1year"), def_serv,plus1 = TRUE)

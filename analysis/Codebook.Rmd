...
* PricingFee i is a numeric variable based on contract pricing. It has a value of 0 for cost-based, 0.5 or "combination or other", 1 for any fixed price (excluding fixed-price level of effort which is classified as cost-based). (`r summary(def_serv$n_Fixed);
...
def_serv<-csis360::read_and_join_experiment(def_serv,
                            ...
                            skip_check_var="principalnaicscodeText"
)
...
NAICS_Lookup <- read.csv(file = "https://raw.githubusercontent.com/CSISdefense/Lookup-Tables/master/economic/Lookup_PrincipalNAICScode.csv")
colnames(NAICS_Lookup) <- c("NAICS_Code", "principalnaicscodeText")

...
summary_continuous_plot(def_serv,"office_psc_obligatedamount_7year",bins=100)
summary_continuous_plot(def_serv,"office_psc_obligatedamount_7year",bins=100, log=TRUE)  #No real point here either

summary(def_serv$office_psc_obligatedamount_7year==0)
summary(def_serv$pOffPSC==0)
...
centered_description(def_serv$office_entity_paircount_7year,"number of years")
...
freq_continuous_plot(def_serv,"l_CA",bins=50)
centered_log_description(def_serv$office_entity_numberofactions_1year,"number of actions")
def_serv$office_entity_numberofactions_1year_plus1<-def_serv$office_entity_numberofactions_1year+1
statsummary_continuous(c("office_entity_numberofactions_1year_plus1"), def_serv)
```

...
freq_continuous_plot(def_serv,"US6_avg_sal_lag1Const",bins=50, log=TRUE)
...
freq_continuous_plot(def_serv,"CFTE_Rate_1year",bins=50, log=TRUE)
...
#### PBSC
```{r PBSC}
#The original variables for cp_OffPerf7 is pPBSC
#In turn pPBSC is the percentage form of office_PBSCobligated_1year / office_obligatedamount_1year

freq_continuous_plot(def_serv,"office_PBSCobligated_1year",bins=50)
freq_continuous_plot(def_serv,"office_PBSCobligated_1year",bins=50, log=TRUE,plus1=TRUE) 


freq_continuous_plot(def_serv,"office_PBSCobligated_1year",bins=50, 
                     denominator="office_obligatedamount_1year",cap1=TRUE)
freq_continuous_plot(def_serv,"office_PBSCobligated_1year",bins=50, 
                     denominator="office_obligatedamount_1year",cap1=TRUE,log=TRUE,plus1=TRUE)#No real point, stick with PBSC
freq_continuous_plot(def_serv,"pPBSC",bins=50, log=TRUE,plus1=TRUE) 
```
...
```{r OffPSC}
#The original variables for cp_OffPerf7 is pOffPSC
#In turn pOffPSC is the percentage form of office_psc_obligatedamount_7year / office_obligatedamount_7year

#Absolute office psc spending 
freq_continuous_plot(def_serv,"office_psc_obligatedamount_7year",bins=50)
freq_continuous_plot(def_serv,"office_psc_obligatedamount_7year",bins=50, log=TRUE, plus1=TRUE)  #This does better.

#Absolute proporitonal psc spending 
freq_continuous_plot(def_serv,"pOffPSC",bins=50)
freq_continuous_plot(def_serv,"pOffPSC",bins=50, log=TRUE, plus1=TRUE)  #No real point here either
...
sum(def_serv$Action_Obligation_OMB20_GDP18[def_serv$EffComp=="No Comp."],na.rm=TRUE)/sum(def_serv$Action_Obligation_OMB20_GDP18,na.rm=TRUE)
sum(def_serv$Action_Obligation_OMB20_GDP18[def_serv$EffComp=="1 Offer"],na.rm=TRUE)/sum(def_serv$Action_Obligation_OMB20_GDP18,na.rm=TRUE)
sum(def_serv$Action_Obligation_OMB20_GDP18[def_serv$EffComp=="2+ Offers"],na.rm=TRUE)/sum(def_serv$Action_Obligation_OMB20_GDP18,na.rm=TRUE)`
)
* CompOffr is a dummy variable based on competition and the number of offers. It's baseline value is No Competition, sole-source contracts, which are intentionally not assigned a dummy to avoid multicollinearity. 

```{r Competition}  
summary(def_serv$CompOffr);
debug(NA_stats)
NA_stats(def_serv,"CompOffr")
sum(def_serv$Action_Obligation_OMB20_GDP18[def_serv$CompOffr=="No Competition"],na.rm=TRUE)/sum(def_serv$Action_Obligation_OMB20_GDP18,na.rm=TRUE)
sum(def_serv$Action_Obligation_OMB20_GDP18[def_serv$CompOffr=="1 offer"],na.rm=TRUE)/sum(def_serv$Action_Obligation_OMB20_GDP18,na.rm=TRUE)
sum(def_serv$Action_Obligation_OMB20_GDP18[def_serv$CompOffr=="2 offers"],na.rm=TRUE)/sum(def_serv$Action_Obligation_OMB20_GDP18,na.rm=TRUE)
sum(def_serv$Action_Obligation_OMB20_GDP18[def_serv$CompOffr=="3-4 offers"],na.rm=TRUE)/sum(def_serv$Action_Obligation_OMB20_GDP18,na.rm=TRUE)
sum(def_serv$Action_Obligation_OMB20_GDP18[def_serv$CompOffr=="5+ offers"],na.rm=TRUE)/sum(def_serv$Action_Obligation_OMB20_GDP18,na.rm=TRUE)
...
# <!-- cln_Def3HHI+clr_Def3toUS+#cl_def3_obl_lag1+ -->
#                             <!-- #cl_US3_avg_sal_lag1+ -->
#                             <!-- cln_Def6HHI+cln_Def6Obl+clr_Def6toUS+ -->
#                             <!-- cln_US6sal+ -->
...
def_serv$clr_Def6toUS[is.nan(def_serv$clr_Def6toUS) | is.infinite(def_serv$clr_Def6toUS)]<-NA
...
summary_continuous_plot(def_serv,"UnmodifiedBase_OMB20_GDP18",bins=50, log=TRUE)
summary_continuous_plot(def_serv,"UnmodifiedBase_OMB20_GDP18",bins=50, log=FALSE)
...
summary_continuous_plot(def_serv,"UnmodifiedDays",bins=50, log=TRUE)
summary_continuous_plot(def_serv,"UnmodifiedDays",bins=50, log=FALSE)
...
sum(def_serv$Action_Obligation_OMB20_GDP18[def_serv$n_Fixed==0],na.rm=TRUE)/sum(def_serv$Action_Obligation_OMB20_GDP18,na.rm=TRUE)
sum(def_serv$Action_Obligation_OMB20_GDP18[def_serv$n_Fixed==0.5],na.rm=TRUE)/sum(def_serv$Action_Obligation_OMB20_GDP18,na.rm=TRUE)
sum(def_serv$Action_Obligation_OMB20_GDP18[def_serv$n_Fixed==1],na.rm=TRUE)/sum(def_serv$Action_Obligation_OMB20_GDP18,na.rm=TRUE)
...
sum(def_serv$Action_Obligation_OMB20_GDP18[def_serv$b_UCA==1],na.rm=TRUE)/sum(def_serv$Action_Obligation_OMB20_GDP18,na.rm=TRUE)

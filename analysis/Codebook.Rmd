...
Percent_Obli <- c()
Total_Obli <- sum(def_dup$Action_Obligation.OMB20_GDP18, na.rm = TRUE)
for (i in Office_Freq$OfficeID) {
  Percent_Obligation <- round(sum(def_dup$Action_Obligation.OMB20_GDP18[def_dup$Office == i], na.rm = TRUE)/Total_Obli,5)
  Percent_Obli <- c(Percent_Obli, Percent_Obligation)
}
...
NAICS_summary<-read_and_join(NAICS_summary,
                        lookup_file = "https://raw.githubusercontent.com/CSISdefense/Lookup-Tables/master/",
                        path="https://raw.githubusercontent.com/CSISdefense/Vendor/master/",
                        dir="economic/",
                        by="principalnaicscode",
                        skip_check_var=c("principalnaicscodeText",
...
#   Percent_Obligation <- round(sum(def_serv$Action_Obligation.OMB20_GDP18[def_serv$NAICS == i], na.rm = TRUE)/Total_Obli,5)
#   Percent_Obli <- c(Percent_Obli, Percent_Obligation)
#   print(i)
# }

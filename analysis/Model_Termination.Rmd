...
stargazer::stargazer(CBre_01C,
  ...
  summary_residual_compare(CBre_01C,Term_01A,Term_01C)
  summary_residual_compare(CBre_01C,Term_01B,Term_01C)
...
#Ceiling Breaches
  stargazer::stargazer(CBre_02A,CBre_02B,CBre_03A,CBre_03B,CBre_03D,
                       type="text",
                       digits=2)



texreg::htmlreg(list(CBre_02A,CBre_02B,CBre_03A,CBre_03B,CBre_03D),file="..//Output//CBre_Model.html",
                single.row = TRUE,
...
#Exercised Options
stargazer::stargazer(Opt_02A,Opt_02B,Opt_03A,Opt_03B,Opt_03D,
                       type="text",
                       digits=2)


texreg::htmlreg(list(Opt_02A,Opt_02B,Opt_03A,Opt_03B,Opt_03D),file="..//Output//Opt_Model.html",
                single.row = TRUE,
                # custom.model.name=c("Ceiling Breaches"),
                stars=c(0.1,0.05,0.01,0.001),
                groups = list(
...
#Scatter Plot
ggplot(serv_opt, aes(x=cl_hh_index_k, y=lp_OptGrowth)) + geom_point(alpha = 0.1) + ggtitle('Exercised Options') + theme(plot.title = element_text(hjust = 0.5))
...
#Ceiling Breaches
  stargazer::stargazer(CBre_02A,CBre_02B,CBre_03A,CBre_03B,CBre_03D,CBre_12C,
                       type="text",
                       digits=2)



texreg::htmlreg(list(CBre_02A,CBre_02B,CBre_03A,CBre_03B,CBre_03D,CBre_12C),file="..//Output//CBre_model_lvl1.html",
                single.row = TRUE,
                # custom.model.name=c("Ceiling Breaches"),
                stars=c(0.1,0.05,0.01,0.001),
                groups = list(
...
#Exercised Options
stargazer::stargazer(Opt_02B,Opt_03A,Opt_03B,Opt_03D,Opt_12C,
                       type="text",
                       digits=2)


texreg::htmlreg(list(Opt_02A,Opt_02B,Opt_03A,Opt_03B,Opt_03D,Opt_12C),file="..//Output//Opt_model_lvl1.html",
                single.row = TRUE,
                # custom.model.name=c("Ceiling Breaches"),
                stars=c(0.1,0.05,0.01,0.001),
                groups = list(

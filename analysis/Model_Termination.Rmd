...
```{r Model15A}
summary_continuous_plot(serv_smp1m,"cln_Base","PricingUCA",metric="cbre")
...
term_salary_pricing_15B <- glm(data=serv_smp, b_Term ~ cln_US6sal + 
                 ...
                 cn_PairHist7+cln_PairCA +
                   ...
                   cln_Def3HHI+clr_Def3toUS+
                   cp_PairObl7+
                   cln_OffObl7+cln_OffFocus + PricingUCA:cl_US6_avg_sal_lag1, 
                 family=binomial(link="logit"))
...
Combination				+	-	-
```{r Model19A}
summary_discrete_plot(serv_smp1m,"cn_PairHist7","PricingUCA")

#Create the models
term_history_pricing_19A_no_interact <- glm(data=serv_smp, b_Term ~ cn_PairHist7 + PricingUCA,
                 family=binomial(link="logit"))
glmer_examine(term_history_pricing_19A_no_interact)

term_history_pricing_19A <- glm(data=serv_smp, b_Term ~ cn_PairHist7 + PricingUCA + cn_PairHist7:PricingUCA,
                 family=binomial(link="logit"))
...
term_history_pricing_19B <- glm(data=serv_smp, b_Term ~ cln_US6sal + 
                 ...
                 cn_PairHist7+cln_PairCA +
                   ...
                   cln_Def3HHI+clr_Def3toUS+
                   cp_PairObl7+
                   cln_OffObl7+cln_OffFocus + cn_PairHist7:PricingUCA,
                 family=binomial(link="logit"))

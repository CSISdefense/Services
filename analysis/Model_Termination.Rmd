...
summary_continuous_plot(serv_smp1m,"cl_Ceil",bins=50)
...
summary_continuous_plot(serv_smp1m,"capped_cl_Days")
...
####04D: Ratio Initial Base : Ceiling Ratio (Logged)
```{r}
...
#Model
Term_04D <- glm(data=serv_smp, b_Term ~ cl_Base2Ceil)
display(Term_04D)

#Plot Residuals vs. Fitted
stargazer::stargazer(Term_12C, Term_04D, type="text", digits=2)
```
...
stargazer::stargazer(
                       Term_03D,Term_04C,Term_04E,
                       
                       type="text",
                       digits=2)


#summary_residual_compare(Term_03D,Term_04E)
#summary_residual_compare(Term_04C,Term_04E)

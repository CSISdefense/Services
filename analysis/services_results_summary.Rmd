...
#Pricing and UCA
                    ...
                    "PricingUCACombination or Other"="Pricing=Comb. or Other",
                    ...
                    "PricingFeeCombination or Other"="Pricing=Comb. or Other",
                    ...
                    "PricingCombination or Other"="Pricing=Comb. or Other",
...
#Crisis and international
                    ...
                    "clr_Def3toUS_lag1"="Log(Subsector Ratio)",
                    "cln_Def6Obl"="Log(Det. Ind. DoD Obl.)",
                    "clr_Def6toUS_lag1"="Log(Det. Ind. Ratio)",

                    #Office
                    "c_pMarket"="Paired Share %",
                    "cl_OffVol"="Office Obl.",
                    ...
                    "cl_US6_avg_sal_lag1:PricingFeeOther FP"="Pricing=Other Fixed-Price:Log(Det. Ind. U.S. Avg. Salary)",
                    ...
                    "cl_US6_avg_sal_lag1:PricingFeeOther CB"="Pricing=Other Cost-Based:Log(Det. Ind. U.S. Avg. Salary)",
                    "cl_US6_avg_sal_lag1:PricingFeeT&M/LH/FPLOE"="Pricing=T&M/LH/FP:LoE:Log(Det. Ind. U.S. Avg. Salary)",
                    "cln_US6sal_lag1:PricingOther FP"="Pricing=Other Fixed-Price:Log(Det. Ind. U.S. Avg. Salary)",
                    "cln_US6sal_lag1:PricingIncentive"="Pricing=Incentive Fee:Log(Det. Ind. U.S. Avg. Salary)",
                    "cln_US6sal_lag1:PricingCombination or Other"="Pricing=Comb./Other:Log(Det. Ind. U.S. Avg. Salary)",
                    "cln_US6sal_lag1:PricingOther CB"="Pricing=Other Cost-Based:Log(Det. Ind. U.S. Avg. Salary)",
                    "cln_US6sal_lag1:PricingT&M/LH/FPLOE"="Pricing=T&M/LH/FP:LoE:Log(Det. Ind. U.S. Avg. Salary)",
                    
                    "c_pairHist:PricingUCAOther FP"="Pricing=Other Fixed-Price:Log(Det. Ind. U.S. Avg. Salary)",
                    ...
                    "c_pairHist:PricingUCAOther CB"="Pricing=Other Cost-Based:Log(Det. Ind. U.S. Avg. Salary)",
                    ...
                    "cn_PairHist7:PricingOther FP"="Pricing=Other Fixed-Price:Log(Det. Ind. U.S. Avg. Salary)",
                    "cn_PairHist7:PricingT&M/LH/FPLOE"="Pricing=T&M/LH/FP:LoE:Log(Det. Ind. U.S. Avg. Salary)",
                    "cn_PairHist7:PricingIncentive"="Pricing=Incentive Fee:Log(Det. Ind. U.S. Avg. Salary)",
                    "cn_PairHist7:PricingOther CB"="Pricing=Other Cost-Based:Log(Det. Ind. U.S. Avg. Salary)",
                    "cn_PairHist7:PricingUCA"="Pricing=UCA:Log(Det. Ind. U.S. Avg. Salary)",
                    "cn_PairHist7:PricingCombination or Other"="Pricing=Comb./Other:Log(Det. Ind. U.S. Avg. Salary)",
                    
                    "cl_Ceil:cl_Base2Ceil"="Log(Init. Ceiling):Log(Init. Ceiling to Base RaTIO)",
                    "cln_Ceil:clr_Ceil2Base"="Log(Init. Ceiling):Log(Init. Ceiling to Base RaTIO)",
                    ...
                    "cl_Base:cl_Base2Ceil"="Log(Init. Base):Log(Init. Ceiling to Base RaTIO)",
                                        "cln_Base:clr_Ceil2Base"="Log(Init. Base):Log(Init. Ceiling to Base RaTIO)"

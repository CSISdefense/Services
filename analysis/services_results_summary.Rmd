...
debug(odds_ratio)
  comp_or_welds<-odds_ratio(b_CBre25A,"b_CBre25A",output="Breach Likelihood",walds=TRUE,rename_list=all_coef_list)
# save(comp.or,file="..//Output//comp.or.rdata")
write.csv(get_study_variables_odds_ratio(comp_or_welds,study="services"),file="..//output//ceiling_breach_study_odds_ratio.csv",row.names=FALSE)
get_icc(b_CBre25A)
...
term.or<-odds_ratio(term25A,"term25A","Concentration","Ceiling Breaches",walds=TRUE)
 get_study_variables_odds_ratio(term.or)

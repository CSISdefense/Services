...
texreg::htmlreg(list(b_SomeOpt25A, b_SomeOpt25C),file="..//Output//some_options_comp.html",
                single.row = TRUE,
                custom.model.name=c("AO 25A", "AO 25B"),
                stars=c(0.1,0.05,0.01,0.001),
                # groups = list(
...
comp.or<-odds_ratio(b_SomeOpt25A,"b_SomeOpt25A",output = "Some Options Exercised Likelihood", walds = TRUE, rename_list=all_coef_list)

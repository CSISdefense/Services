...
# texreg::htmlreg(list(b_CBre12C,CBre_Comp_13C,CBre_Cons_Comp_15A),file="..//output//CBre_Model.html",single.row = TRUE,
...
texreg::htmlreg(list(b_CBre12C.restart,CBre_Comp_13C,CBre_Cons_Comp_15A),file="..//output//CBre_Model.html",
                single.row = TRUE,
                custom.model.name=c("Concentration",
                                    "Competition",
                                    "Both"),

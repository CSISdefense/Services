...
Percent_Obli <- c()
Total_Obli <- sum(def_serv$Action_Obligation_Then_Year, na.rm = TRUE)
for (i in NAICS2_Freq$NAICS_Code) {
  Percent_Obligation <- round(sum(def_serv$Action_Obligation_Then_Year[def_serv$NAICS2 == i], na.rm = TRUE)/Total_Obli,5)
...
sum(def_serv$Action_Obligation_Then_Year[def_serv$EffComp=="No Comp."],na.rm=TRUE)/sum(def_serv$Action_Obligation_Then_Year,na.rm=TRUE)
sum(def_serv$Action_Obligation_Then_Year[def_serv$EffComp=="1 Offer"],na.rm=TRUE)/sum(def_serv$Action_Obligation_Then_Year,na.rm=TRUE)
sum(def_serv$Action_Obligation_Then_Year[def_serv$EffComp=="2+ Offers"],na.rm=TRUE)/sum(def_serv$Action_Obligation_Then_Year,na.rm=TRUE)
nrow(def_serv[def_serv$EffComp=="No Comp.",])/nrow(def_serv)

sum(def_serv$Action_Obligation_Then_Year[is.na(def_serv$EffComp)],na.rm=TRUE)/sum(def_serv$Action_Obligation_Then_Year,na.rm=TRUE)

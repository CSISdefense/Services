...
load("..//Output//b_SomeOpt25B.rda")
load("..//Output//b_AllOpt25B.rda")
glmer_examine(b_SomeOpt25B)
glmer_examine(b_AllOpt25B)


load("..//Output//b_SomeOpt25C.rda")
glmer_examine(b_SomeOpt25C)
load("..//Output//b_SomeOpt25Cv2.rda")
...
texreg::htmlreg(list(b_SomeOpt25A, b_SomeOpt25C, b_SomeOpt25Cv2),file="..//Output//some_options_comp.html",
                single.row = TRUE,
...
#Chart for report:
texreg::htmlreg(list(b_SomeOpt25Cv2, b_AllOpt25A),file="..//Output//options.html",
                single.row = TRUE,
...
texreg::htmlreg(list(b_CBre28B,n_CBre25A,term25B),file="..//Output//service_complexity.html",
                single.row = TRUE,
...
office_coef<-all_coef_list[sort(c(grep("c_pPBSC",names(all_coef_list)),
...
texreg::htmlreg(list(b_CBre28B,n_CBre25A,term25B),file="..//Output//office_capacity.html",
                single.row = TRUE,
                custom.model.name=c("Ceiling Breach\nLikelihood\n(Logit)",
                                    "Ceiling Breach\nSize Given Breach\n(Regression)",
                                    "Termination\n(Logit)"),
...
texreg::htmlreg(list(b_CBre28B,n_CBre25A,term25B),file="..//Output//pair_history.html",
                single.row = TRUE,
                custom.model.name=c("Ceiling Breach\nLikelihood\n(Logit)",
                                    "Ceiling Breach\nSize Given Breach\n(Regression)",
                                    "Termination\n(Logit)"),
...
comp.or<-odds_ratio(b_SomeOpt25Cv2,"b_SomeOpt25Cv2",output = "Some Options Exercised Likelihood", walds = TRUE, rename_list=all_coef_list)
...
get_icc(b_SomeOpt25Cv2)

# #https://www.lcampanelli.org/mixed-effects-modeling-lme4/
# gridExtra::grid.arrange(dotplot(ranef(b_SomeOpt25A, condVar = T), strip = T, scales=list(relation='free'))$Agency,
#              nrow=1)

comp.or<-odds_ratio(b_AllOpt25A,"b_AllOpt25A",output = "All Options Exercised Likelihood", walds = TRUE, rename_list=all_coef_list)

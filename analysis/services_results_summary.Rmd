...
#MODELS - b_SomeOpt25Cv3; b_AllOpt25A

stargazer::stargazer(b_SomeOpt25Cv3, b_AllOpt25A,
                       single.row = TRUE,
...
#Chart for report:
texreg::htmlreg(list(b_SomeOpt25Cv3, b_AllOpt25A),file="..//Output//options.html",
                single.row = TRUE,
...
#To be transfered to Model_Some_and_All_Options file
...
texreg::htmlreg(list(b_SomeOpt25A, b_SomeOpt25C, b_SomeOpt25Cv2, b_SomeOpt25Cv3),file="..//Output//some_options_comp.html",
                single.row = TRUE,
...
texreg::htmlreg(list(b_SomeOpt25Cv2,b_AllOpt25A,b_CBre28B,n_CBre25A,term25B),file="..//Output//service_complexity.html",
                single.row = TRUE,
...
texreg::htmlreg(list(b_SomeOpt25Cv2,b_AllOpt25A,b_CBre28B,n_CBre25A,term25B),file="..//Output//office_capacity.html",
                single.row = TRUE,
                custom.model.name=c("Some Options\nExercised\n(Logit)",
                                    "All Options\nExercised\n(Logit)",
                                    "Ceiling Breach\nLikelihood\n(Logit)",

...
#MODELS - b_SomeOpt25Cv3; b_AllOpt25B

stargazer::stargazer(b_SomeOpt25Cv3, b_AllOpt25B,
                       single.row = TRUE,
...
texreg::htmlreg(list(b_SomeOpt25Cv3, b_AllOpt25B),file="..//Output//options.html",
                single.row = TRUE,
...
comp.or<-odds_ratio(b_AllOpt25B,"b_AllOpt25B",output = "All Options Exercised Likelihood", walds = TRUE, rename_list=all_coef_list)
...
debug(get_study_variables_odds_ratio)
...
texreg::htmlreg(list(b_SomeOpt25Cv3,b_AllOpt25B,b_CBre29B,n_CBre25A,term25B),file="..//Output//service_complexity.html",
                single.row = TRUE,
...
texreg::htmlreg(list(b_SomeOpt25Cv3,b_AllOpt25B,b_CBre29B,n_CBre25A,term25B),
...
options_residual<-gridExtra::grid.arrange(
  binned_fitted_versus_residuals(b_SomeOpt25Cv3,bins=50)+
    ...
    binned_fitted_versus_residuals(b_AllOpt25B,bins=50)+
      labs(title="All Options Binned Actuals",
           caption=NULL,
           x="Estimated Pr(All Options | Some Options)",y="Actual Pr(All Options | Some Options)"),
  residuals_binned(b_AllOpt25B, bins=50)+labs(title="All Options Binned Residuals",

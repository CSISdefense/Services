...
$β_{`r (b<-b+1)`}Office~Perf.-Based~%_{i}~+$
...
$β_{`r (b<-b+1)`}Log(Subsector~DoD:US)_{i}~+~$
$β_{`r (b<-b+1)`}Log(Det.~Ind.~HHI)_{i}~+~$
$β_{`r (b<-b+1)`}Log(Det.~Ind.~DoD:US)_{i}~+~$
$β_{`r (b<-b+1)`}Log(Office~Obl.+1)_{i}~+$
$β_{`r (b<-b+1)`}Log(Office~Focus)_{i}~+~$
$β_{`r (b<-b+1)`}Paired~Share_{i}~+~$\newline\
$β_{`r (b<-b+1)`}Office~Serv.~Code~Exp.~\%_{i}·Log(Office~Obl.+1)_{i}~+~$\newline\
$β_{`r (b<-b+1)`}cln\_OffPerf7_{i}·Log(Paired~Actions+1)_{i}~+~$
...
$β_{`r (b<-b+1)`}Paired~Share_{i}·Log(Office~Obl.+1)_{i}~+~$
...
$β_{`r (b<-b+1)`}cln\_OffPSC7_{i}·Log(Office~Focus)_{i}~+$\newline\
$β_{`r (b<-b+1)`}cln\_OffPerf7_{i}·Paired~Share_{i}~+~$
$β_{`r (b<-b+1)`}Log(Office~Obl.+1)_{i}·Log(Office~Focus)_{i}~+~$\newline\
...
$β_{`r (b<-b+1)`}Paired~Share_{i}~+~$
$β_{`r (b<-b+1)`}cln\_OffPerf7_{i}·Log(Paired~Actions+1)_{i}~+$\newline\
$β_{`r (b<-b+1)`}cln\_OffPerf7_{i}·Log(Planned~Dur.)_{i}~+~$
...
$β_{`r (b<-b+1)`}Log(Office~Focus)_{i}~+~$
$β_{`r (b<-b+1)`}Paired~Share_{i}~+$
$β_{`r (b<-b+1)`}Office~Perf.-Based~%_{i}·Log(Paired~Actions+1)_{i}~+~ϵ_{i}~+~$\newline\

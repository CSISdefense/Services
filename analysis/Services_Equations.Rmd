...
$β_{9}cln\_Days_{i}~+~(~β_{10}1Offr~+~β_{11}2–4Offr_{i}+~β_{12}5plusOffr_{i}~)~+$
...
$β_{22}UCA_{i}~)~+~β_{23}OCO_{i}~+~β_{24}ARRA_{i}~+~β_{25}Dist_{i}$

$β_{26}clr\_Def3toUS{i}~+~β_{27}cln\_Def6HHI_{i}~+~β_{28}clr\_Def6toUS_{i}~+~$

$β_{29}cp\_PairObl7_{i}~+~β_{30}cln\_OffObl7_{i}~+~β_{31}cln\_OffFocus_{i}~+$
...
$β_{33}cp\_OffPerf7_{i}·cln\_PairCA_{i}, for~i=  1~to~1,000,000$

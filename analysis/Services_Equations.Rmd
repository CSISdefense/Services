...
$(~β_{23}OCO_{i}~+~β_{24}ARRA_{i}~+~β_{25}Dist_{i}~+~β_{26}clr\_Def3toUS{i}~+~β_{27}cln\_Def6HHI_{i}~+$
...
$β_{32}cln\_Base_{i}·b\_UCA_{i}~+~β_{33}cln\_Def6HHI_{i}·cln\_OffObl7_{i}~+$

...
summary_continuous_plot(serv_opt,metric="cbre","cln_US6sal")

#Scatter Plot of b_AllOpt01A
ggplot(serv_opt, aes(x=cln_US6sal, y=lb_AllOpt)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
summary_continuous_plot(serv_opt,metric="cbre","cln_PSCrate")

#Scatter Plot 
ggplot(serv_opt, aes(x=cln_PSCrate, y=lb_AllOpt)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
b_AllOpt01C <- glm(data=serv_exeropt, family=binomial(link="logit"),
                        lb_AllOpt ~ cln_US6sal +  cln_PSCrate)
...
summary_continuous_plot(serv_opt,metric="cbre","pPBSC")

#Scatter Plot 
ggplot(serv_opt, aes(x=cp_OffPerf7, y=lb_AllOpt)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
summary_continuous_plot(serv_opt,metric="cbre","cp_OffPSC7")

#Scatter Plot 
ggplot(serv_opt, aes(x=cp_OffPSC7, y=lb_AllOpt)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
b_AllOpt02C <- glm(data=serv_exeropt, family=binomial(link="logit"),
                        lb_AllOpt ~ cp_OffPerf7+cp_OffPSC7)
...
b_AllOpt02D <- glm(data=serv_exeropt, family=binomial(link="logit"),
                        lb_AllOpt ~ cln_US6sal + cln_PSCrate+ cp_OffPSC7)
...
summary_discrete_plot(serv_opt,metric="cbre","cn_PairHist7")

#Scatter Plot
ggplot(serv_opt, aes(x=cn_PairHist7, y=lb_AllOpt)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
summary_continuous_plot(serv_opt,metric="cbre","cln_PairCA")

#Scatter Plot
ggplot(serv_opt, aes(x=cln_PairCA, y=lb_AllOpt)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
b_AllOpt03C <- glm(data=serv_exeropt, family=binomial(link="logit"),
                        lb_AllOpt ~ cn_PairHist7+cln_PairCA)
...
summary_continuous_plot(serv_opt,metric="cbre","UnmodifiedCeiling_OMB20_GDP18",bins=1000)
summary_continuous_plot(serv_opt,metric="cbre","UnmodifiedCeiling_OMB20_GDP18",bins=50,log=TRUE)


#Scatter Plot
ggplot(serv_opt, aes(x=cl_Ceil, y=lb_AllOpt)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
summary_continuous_plot(serv_opt,metric="cbre","cln_Days")

#Scatter Plot
ggplot(serv_opt, aes(x=cln_Days, y=lb_AllOpt)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
```{r Model04C}
summary_continuous_plot(serv_opt,metric="cbre", "clr_Ceil2Base")

#Scatter Plot
ggplot(serv_opt, aes(x=clr_Ceil2Base, y=lb_AllOpt)) + geom_point(alpha = 0.1) + ggtitle("Terminations and Ratio Initial Base:Ceiling Ratio (Logged") + theme(plot.title = element_text(hjust = 0.5))
...
b_AllOpt04C <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ clr_Ceil2Base)
...
b_AllOpt04D <- glm(data=serv_exeropt, family=binomial(link="logit"),
                        lb_AllOpt ~cl_Ceil + cln_Days + clr_Ceil2Base)
...
#Likelihood Plot for unlogged ceiling
summary_continuous_plot(serv_opt,metric="cbre","UnmodifiedBase_OMB20_GDP18",bins=1000)
summary_continuous_plot(serv_opt,metric="cbre","UnmodifiedBase_OMB20_GDP18",bins=50,log=TRUE)


#Scatter Plot
ggplot(serv_opt, aes(x=cln_Base, y=lb_AllOpt)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
b_AllOpt04F <- glm(data=serv_exeropt, family=binomial(link="logit"),
                        lb_AllOpt ~cln_Base + cln_Days  + clr_Ceil2Base)
...
```{r Model05A}
summary_discrete_plot(serv_opt,metric="cbre","Comp")



#Scatter Plot
ggplot(serv_opt, aes(x=Comp, y=lb_AllOpt)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
summary_discrete_plot(serv_opt,metric="cbre","Veh")


#Scatter Plot
ggplot(serv_opt, aes(x=Veh, y=lb_AllOpt)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
serv_opt$Pricing<-factor(serv_opt$Pricing,
                            levels=c( "FFP","Other FP","T&M/LH/FPLOE","Incentive","Other CB","UCA" ,"Combination or Other" ))
  summary_discrete_plot(serv_opt,metric="cbre","Pricing")

#Scatter Plot
ggplot(serv_opt, aes(x=Pricing, y=lb_AllOpt)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
#### 08A: Crisis Funding
```{r Model08A}
summary_discrete_plot(serv_opt,metric="cbre","Crisis")
#Scatter Plot
ggplot(serv_opt, aes(x=Crisis, y=lb_AllOpt)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
```{r Model09A}
#Likelihood Plot for unlogged ceiling
summary_continuous_plot(serv_opt,metric="cbre","def6_HHI_lag1")
summary_continuous_plot(serv_opt,metric="cbre","cln_Def6HHI")
summary_continuous_plot(serv_opt,metric="cbre","cln_Def3HHI")
...
```{r Model09B}
#Likelihood Plot for unlogged ceiling
      summary_continuous_plot(serv_opt,metric="cbre","def6_ratio_lag1")

      summary_continuous_plot(serv_opt,metric="cbre","clr_Def6toUS")
      


#Scatter Plot
ggplot(serv_opt, aes(x=clr_Def6toUS, y=lb_AllOpt)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
```{r Model09C}
#Likelihood Plot for unlogged ceiling
      summary_continuous_plot(serv_opt,metric="cbre","def6_obl_lag1Const")

      summary_continuous_plot(serv_opt,metric="cbre","cln_Def6OblConst")
      


#Scatter Plot
ggplot(serv_opt, aes(x=cln_Def6OblConst, y=lb_AllOpt)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
b_AllOpt09D <- glm(data=serv_exeropt, family=binomial(link="logit"),
                        lb_AllOpt ~ cln_Def6HHI+clr_Def6toUS+cln_Def6OblConst)
...
#Scatter Plot
ggplot(serv_opt, aes(x=cln_Def3HHI, y=lb_AllOpt)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
```{r Model10B}
#Likelihood Plot for unlogged ceiling
summary_continuous_plot(serv_opt,metric="cbre","capped_def3_ratio_lag1")
summary_continuous_plot(serv_opt,metric="cbre","clr_Def3toUS")
...
b_AllOpt10C2 <- glm(data=serv_exeropt, family=binomial(link="logit"),
                        lb_AllOpt ~ cln_Def6HHI+clr_Def6toUS+
                   cln_Def3HHI+clr_Def3toUS)
...
b_AllOpt10C3 <- glm(data=serv_exeropt, family=binomial(link="logit"),
                        lb_AllOpt ~ clr_Def6toUS+cln_Def6OblConst+
                   cln_Def3HHI+clr_Def3toUS)
...
summary_continuous_plot(serv_opt,metric="cbre","cp_PairObl7")

#Scatter Plot
ggplot(serv_opt, aes(x=cp_PairObl7, y=lb_AllOpt)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
summary_continuous_plot(serv_opt,metric="cbre","cln_OffObl7")

#Scatter Plot
ggplot(serv_opt, aes(x=cln_OffObl7, y=lb_AllOpt)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
```{r Model12B}
summary_continuous_plot(serv_opt,metric="cbre","cln_OffFocus")

#Scatter Plot
ggplot(serv_opt, aes(x=cln_OffFocus, y=lb_AllOpt)) + geom_point(alpha = 0.1) + ggtitle('Ceiling Breach Growth') + theme(plot.title = element_text(hjust = 0.5))
...
b_AllOpt_salary_pricing_15A_no_interact <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ Pricing + cl_US6_avg_sal_lag1)
glmer_examine(b_AllOpt_salary_pricing_15A_no_interact)

b_AllOpt_salary_pricing_15A <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ Pricing + cl_US6_avg_sal_lag1 + Pricing:cl_US6_avg_sal_lag1)
...
b_AllOpt_salary_pricing_15B <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
b_AllOpt_partnership_actions_16A_no_interact <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cp_OffPerf7 + cln_PairCA)
glmer_examine(b_AllOpt_partnership_actions_16A_no_interact)

b_AllOpt_partnership_actions_16A <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cp_OffPerf7 + cln_PairCA + cp_OffPerf7:cln_PairCA)
...
b_AllOpt_partnership_actions_16B <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
b_AllOpt_partnership_share_17A_no_interact <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cp_OffPerf7 + cp_PairObl7)
glmer_examine(b_AllOpt_partnership_share_17A_no_interact)

b_AllOpt_partnership_share_17A <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cp_OffPerf7 + cp_PairObl7 + cp_OffPerf7:cp_PairObl7)
...
b_AllOpt_partnership_share_17B <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
b_AllOpt_partnership_share_17B2 <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
b_AllOpt17C_no_interact <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cln_OffObl7 + cp_PairObl7)
glmer_examine(b_AllOpt17C_no_interact)

b_AllOpt17C <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cln_OffObl7 + cp_PairObl7 + cln_OffObl7:cp_PairObl7)
...
b_AllOpt17D <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
b_AllOpt17D2 <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
b_AllOpt_partnership_duration_18A_no_interact <- glm(data=serv_breach , lb_AllOpt ~ cp_OffPerf7 + cln_Days)
glmer_examine(b_AllOpt_partnership_duration_18A_no_interact)

b_AllOpt_partnership_duration_18A <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cp_OffPerf7 + cln_Days + cp_OffPerf7: cln_Days)
...
b_AllOpt_partnership_duration_18B <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
b_AllOpt_partnership_duration_18B2 <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
b_AllOpt_history_pricing_19A_no_interact <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cn_PairHist7 + Pricing)
glmer_examine(b_AllOpt_history_pricing_19A_no_interact)

b_AllOpt_history_pricing_19A <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cn_PairHist7 + Pricing + cn_PairHist7:Pricing)
...
b_AllOpt_history_pricing_19B <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
b_AllOpt_history_pricing_19B2 <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
b_AllOpt_competition_NAICS66_20A_no_interact <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ Comp + cln_Def6HHI)
glmer_examine(b_AllOpt_competition_NAICS66_20A_no_interact)

b_AllOpt_competition_NAICS66_20A <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ Comp + cln_Def6HHI + Comp:cln_Def6HHI)
...
b_AllOpt_competition_NAICS66_20A_no_interact <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ Comp + cln_Def3HHI)
glmer_examine(b_AllOpt_competition_NAICS66_20A_no_interact)

b_AllOpt_competition_NAICS66_20A <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ Comp + cln_Def3HHI + Comp:cln_Def3HHI)
glmer_examine(b_AllOpt_competition_NAICS66_20A)
...
b_AllOpt_competition_NAICS66_20B <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
b_AllOpt_competition_NAICS66_20B2 <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
b_AllOpt_competition_naincs3_20B <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
b_AllOpt_competition_naincs3_20B2 <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
b_AllOpt_base2ceil_ceiling_21A_no_interact <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ clr_Ceil2Base + cln_Base)

glmer_examine(b_AllOpt_base2ceil_ceiling_21A_no_interact)

b_AllOpt_base2ceil_ceiling_21A <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ clr_Ceil2Base + cln_Base + clr_Ceil2Base:cln_Base)
...
b_AllOpt_base2ceil_ceiling_21B <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
b_AllOpt_base2ceil_ceiling_21B2 <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
b_AllOpt_base2ceil_duration_21C_no_interact <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ clr_Ceil2Base + cln_Days)
glmer_examine(b_AllOpt_base2ceil_duration_21C_no_interact)

b_AllOpt_base2ceil_duration_21C <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ clr_Ceil2Base + cln_Days + clr_Ceil2Base:cln_Days)
...
b_AllOpt_base2ceil_duration_21D <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
b_AllOpt_base2ceil_duration_21D2 <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
b_AllOpt_CFTE_pricing_22A_no_interact <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ Pricing + cln_PSCrate)
glmer_examine(b_AllOpt_CFTE_pricing_22A_no_interact)

b_AllOpt_CFTE_pricing_22A <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ Pricing + cln_PSCrate + Pricing:cln_PSCrate)
...
b_AllOpt_CFTE_pricing_22B <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
b_AllOpt_CFTE_pricing_22B2 <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
b_AllOpt23A_no_interact <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ pOffPSC + cln_OffObl7)
glmer_examine(b_AllOpt23A_no_interact)

b_AllOpt23A <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ pOffPSC + cln_OffObl7 + pOffPSC:cln_OffObl7)
...
b_AllOpt23B <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
b_AllOpt23B2 <- glm(data=serv_exeropt, family=binomial(link="logit"), lb_AllOpt ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
...
#Create the model
  ...
  b_AllOpt25A <- lmer(data=serv_breach, lb_AllOpt ~ cln_US6sal + 
                      cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                      cn_PairHist7+cln_PairCA+
                      cln_Base + clr_Ceil2Base + cln_Days+
                      Comp+
...
if(!exists("b_AllOpt26A")){
  #Create the model
  b_AllOpt26A <- lmer(data=serv_breach, lb_AllOpt ~ cln_US6sal + 
                      cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                      cn_PairHist7+cln_PairCA+
                      cln_Base + clr_Ceil2Base + cln_Days+
                      Comp+

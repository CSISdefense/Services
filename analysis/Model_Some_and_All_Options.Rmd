...
The results remain contrary to expectations and do little for VIF (restoring pairCA also outright raises AIC for the some model). Leaving it out.
...
#Create the model
  ...
  save(b_AllOpt25A,file="..\\output\\b_AllOpt25A.rda")
}
...
if(!exist("b_SomeOpt25B")){
  b_SomeOpt25B <- glmer(data=serv_opt, b_SomeOpt ~  cln_US6sal +
                        ...
                        family=binomial(link="logit"),
                        verbose=TRUE)
  save(b_SomeOpt25B, file="..\\Output\\b_SomeOpt25B.rda")
...
stargazer::stargazer(b_AllOpt25A, b_AllOpt25A, type = "text", digits = 2)
# 
...
####25C: 2019-08-29 - Modified SomeOpt and AllOpt models to more accurately reflect variable trimming in prior sections.
...
if(file.exists("..//Output//b_SomeOpt25Cv3"))  load("..//Output//b_SomeOpt25Cv3")

if(!exist("b_SomeOpt25Cv3")){

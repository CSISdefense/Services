...
In AllOpt model, cp_OffPSC7 has been dropped from the model.  In SomeOpt model, both cp_OffPSC7 and cln_PairCA have been dropped.
...
#Compare the models
stargazer::stargazer(b_SomeOpt13A, b_SomeOpt_partnership_actions_16B, 
                     b_AllOpt12C, b_AllOpt_partnership_actions_16B, type="text", digits=2)

summary_residual_compare(b_SomeOpt13A, b_SomeOpt_partnership_actions_16B,
                         b_AllOpt12C, b_AllOpt_partnership_actions_16B,bins=50)
```

The results remain contrary to expectations and do little for VIF (restoring pairCA is outright raises AIC for the some model). Leaving it out.
...
#Compare the models
stargazer::stargazer(b_SomeOpt_partnership_share_17B, b_SomeOpt17D, b_SomeOpt17D,
                     b_AllOpt_partnership_share_17B, b_AllOpt17D2, type="text", digits=2)


stargazer::stargazer(b_SomeOpt_partnership_share_17B, 
                     b_AllOpt_partnership_share_17B, type="text", digits=2)

stargazer::stargazer(b_SomeOpt17D, 
                     b_AllOpt17D, type="text", digits=2)
...
AllOpt: cp_PairObl7, cln_OffFocus, and both interactions meet expectations.


Current cumulative b_SomeOpt model: b_SomeOpt17D
Current cumulative b_AllOpt model: b_AllOpt17D
...
summary_residual_compare(b_SomeOpt_partnership_share_17B, b_SomeOpt_partnership_duration_18B, bins = 50)
summary_residual_compare(b_AllOpt_partnership_share_17B, b_AllOpt_partnership_duration_18B2, bins = 50)
```
In both models, interaction terms lose their significance.  Residuals for b_SomeOpt model are edigng towards intolerable, and since the interaction isn't significant in either model specification, dropping it.
...
summary_residual_compare(b_SomeOpt_partnership_duration_18B, b_SomeOpt_history_pricing_19B, bins = 50)
summary_residual_compare(b_AllOpt_partnership_share_17B, b_AllOpt_history_pricing_19B, bins = 50)
```
SomeOpt: Expectations met for incentive pricing interaction ad combination pricing interaction
AllOpt: Expectations are not met for any interactions

Current cumulative b_SomeOpt model: b_SomeOpt_history_pricing_19B
Current cumulative b_AllOpt model: b_AllOpt_history_pricing_19B
...
b_AllOpt_base2ceil_ceiling_21Bv2 <- glm(data=serv_exeropt, family=binomial(link="logit"), b_AllOpt ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
                 Comp+
                 ...
                 cp_OffPerf7:cp_PairObl7+
                   cp_OffPerf7:cln_PairCA + 
                   cn_PairHist7:Pricing)
glmer_examine(b_AllOpt_base2ceil_ceiling_21Bv2)

b_AllOpt_base2ceil_ceiling_21Bv3 <- glm(data=serv_exeropt, family=binomial(link="logit"), b_AllOpt ~ cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+cln_PairCA+
                 ...
                 cp_OffPerf7:cp_PairObl7+
                   ...
                   cn_PairHist7:Pricing + 
                 clr_Ceil2Base:cln_Base)
glmer_examine(b_AllOpt_base2ceil_ceiling_21Bv3)

#Compare the models
stargazer::stargazer(b_SomeOpt_partnership_duration_18B, b_SomeOpt_base2ceil_ceiling_21B, 
                     b_AllOpt_partnership_share_17B, b_AllOpt_base2ceil_ceiling_21B2,  type="text", digits=2)

stargazer::stargazer(b_AllOpt_base2ceil_ceiling_21Bv2, b_AllOpt_base2ceil_ceiling_21Bv3, type = "text", digits = 2)

summary_residual_compare(b_SomeOpt_partnership_duration_18B, b_SomeOpt_base2ceil_ceiling_21B, bins = 50)
summary_residual_compare(b_AllOpt_partnership_share_17B, b_AllOpt_base2ceil_ceiling_21B2, bins = 50)
summary_residual_compare(b_AllOpt_base2ceil_ceiling_21Bv2, b_AllOpt_base2ceil_ceiling_21Bv3, bins = 50)
```
SomeOpt: Expectation met
AllOpt: Scaled GVIF above threshold for cln_Base and cln_Base:clr_Ceil2Base.  Two alternative models set-up: model v2, which drops cln_base:clr_Ceil2Base and model v3, which drops cln_Base. Scaled VIF acceptable in both models.  Residuals borderline acceptable, more worrying in model v3.  Given that base meets expectations, and the interaction term does not, and the slight edge model v2 has in residuals, we choose to retain model v2 (i.e. drop the interaction term), despite v3 having a marginally lower AIC (also because not a great idea to include an interaction term without including one of its component variables).

Current cumulative b_SomeOpt model: b_SomeOpt_base2ceil_ceiling_21B
Current cumulative b_AllOpt model: b_AllOpt_base2ceil_ceiling_21Bv2
...
stargazer::stargazer(b_SomeOpt_base2ceil_ceiling_21B, b_SomeOpt_base2ceil_duration_21D, 
                     b_AllOpt_base2ceil_ceiling_21Bv2, b_AllOpt_base2ceil_duration_21D, type="text", digits=2)

summary_residual_compare(b_SomeOpt_base2ceil_ceiling_21B, b_SomeOpt_base2ceil_duration_21D, bins = 50)
summary_residual_compare(b_AllOpt_base2ceil_ceiling_21Bv2, b_AllOpt_base2ceil_duration_21D)
```
Not included in AllOpt model.  Statistically significant and disagrees with expectations in SomeOpt model.  Raises VIF.  Choose not to include.
...
#Compare the models
  stargazer::stargazer(b_SomeOpt_base2ceil_ceiling_21B, b_SomeOpt_CFTE_pricing_22B, 
                       b_AllOpt_partnership_share_17B, b_AllOpt_CFTE_pricing_22B2, type="text", digits=2)
...
#Compare the models
  stargazer::stargazer(b_SomeOpt_base2ceil_ceiling_21B, b_SomeOpt23B, 
                       b_AllOpt_base2ceil_ceiling_21Bv2, b_AllOpt23B, type="text", digits=2)

summary_residual_compare(b_SomeOpt_base2ceil_ceiling_21B, b_SomeOpt23B, bins = 50)
summary_residual_compare(b_AllOpt_base2ceil_ceiling_21Bv2, b_AllOpt23B, bins = 50)

```
For SomeOpt, interaction violates expectations.  For AllOpt, interaction meets expectations.

Current cumulative b_SomeOpt model: b_SomeOpt23B
Current cumulative b_AllOpt model: b_AllOpt23B
...
```
Ignored, because both models already include in these variables.
...
b_AllOpt24B_no_interact <- glm(data=serv_exeropt, b_AllOpt ~ pOffPSC + cln_OffFocus, 
                                             family=binomial(link="logit"))
glmer_examine(b_AllOpt24B_no_interact)

b_AllOpt24B <- glm(data=serv_exeropt, b_AllOpt ~ pOffPSC + cln_OffFocus + pOffPSC:cln_OffFocus, family = binomial(link = "logit"))
glmer_examine(b_AllOpt24B)

stargazer::stargazer(b_AllOpt24B, type = "text", digits = 2)

```
VIF measures indicate multicolinearity for SomeOpt model.  Requires checking of cumulative model specification for AllOpt, where it is accepted.  Expectations met for AllOpt model.
...
b_AllOpt24C <- glm(data=serv_exeropt, family=binomial(link="logit"), b_AllOpt ~ cln_US6sal + 
                 ...
                 cln_OffFocus+
                  ...
                  cp_OffPerf7:cln_PairCA + 
                    cp_OffPerf7:cln_PairCA + 
                   pOffPSC:cln_OffObl7 +
                   pOffPSC:cln_OffFocus)
glmer_examine(b_AllOpt24C)
stargazer::stargazer(b_AllOpt23B, b_AllOpt24C, type = "text", digits = 2)
summary_residual_compare(b_AllOpt23B, b_AllOpt24C, bins = 50)
```
VIF precludes inclusion for SomeOpt.
...
summary_residual_compare(b_SomeOpt23B, bins = 50)
...
#Compare the models
  stargazer::stargazer(b_SomeOpt23B, b_SomeOpt24E, type="text", digits=2)
  stargazer::stargazer(b_AllOpt24C, b_AllOpt24E, type = "text", digits=2)

summary_residual_compare(b_SomeOpt23B, b_SomeOpt24E)
summary_residual_compare(b_AllOpt24C, b_AllOpt24E)

```
SomeOpt - insignificant, and raises AIC  Leaving out.
AllOpt - inclusion pushes VIF above acceptable levels.  Given inclusion raises AIC, opt not to include.

Final pre-multilevel run model selections are:
SomeOpt: b_SomeOpt23B
AllOpt: b_AllOpt24C
...
```{r CBre25A}
if(file.exists("..//Output//Opt25A.rda")) load("..//Output//Opt25A.rda")
...
#Create the model
  b_SomeOpt25A <- glmer(data=serv_opt, b_SomeOpt ~  cln_US6sal +
                     ...
                     family=binomial(link="logit"),
                     verbose=TRUE)
  save(b_SomeOpt25A, file = "..\\output\\b_SomeOpt25A.rda")
  
  
  b_AllOpt25A <- glmer(data=serv_breach, b_AllOpt ~ cln_US6sal + 
                      cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                      cn_PairHist7+cln_PairCA+
                      cln_Base + clr_Ceil2Base + cln_Days+
                      Comp+
...
stargazer::stargazer(b_SomeOpt_base2ceil_ceiling_21B, b_SomeOpt25A, 
                     b_AllOpt_partnership_share_17B, b_AllOpt25A, type="text", digits=2)

...
contract_transform_verify(serv_opt,just_check_na = TRUE)
contract_transform_verify(serv_exeropt,just_check_na = TRUE)
...
b_SomeOpt07A <- glm (data=serv_opt,
                 b_SomeOpt ~ PricingUCA, family=binomial(link="logit"))
...
```{r Model15A}
#Create the models
b_SomeOpt_salary_pricing_15A_no_interact <- glm(data=serv_opt, b_SomeOpt ~ PricingUCA + cl_US6_avg_sal_lag1, 
                                             family=binomial(link="logit"))
glmer_examine(b_SomeOpt_salary_pricing_15A_no_interact)

b_SomeOpt_salary_pricing_15A <- glm(data=serv_opt, b_SomeOpt ~ PricingUCA + cl_US6_avg_sal_lag1 + PricingUCA:cl_US6_avg_sal_lag1,
                                 family=binomial(link="logit"))
glmer_examine(b_SomeOpt_salary_pricing_15A)


b_AllOpt_salary_pricing_15A_no_interact <- glm(data=serv_exeropt, family=binomial(link="logit"), b_AllOpt ~ PricingUCA + cl_US6_avg_sal_lag1)
glmer_examine(b_AllOpt_salary_pricing_15A_no_interact)

b_AllOpt_salary_pricing_15A <- glm(data=serv_exeropt, family=binomial(link="logit"), b_AllOpt ~ PricingUCA + cl_US6_avg_sal_lag1 + PricingUCA:cl_US6_avg_sal_lag1)
...
```{r Model19A}
#Create the models
b_SomeOpt_history_pricing_19A_no_interact <- glm(data=serv_opt, b_SomeOpt ~ cn_PairHist7 + PricingUCA, family=binomial(link="logit"))
glmer_examine(b_SomeOpt_history_pricing_19A_no_interact)

b_SomeOpt_history_pricing_19A <- glm(data=serv_opt, b_SomeOpt ~ cn_PairHist7 + PricingUCA + cn_PairHist7:PricingUCA, family=binomial(link="logit"))
glmer_examine(b_SomeOpt_history_pricing_19A)

b_AllOpt_history_pricing_19A_no_interact <- glm(data=serv_exeropt, family=binomial(link="logit"), b_AllOpt ~ cn_PairHist7 + PricingUCA)
glmer_examine(b_AllOpt_history_pricing_19A_no_interact)

b_AllOpt_history_pricing_19A <- glm(data=serv_exeropt, family=binomial(link="logit"), b_AllOpt ~ cn_PairHist7 + PricingUCA + cn_PairHist7:PricingUCA)
...
b_SomeOpt_history_pricing_19B <- glm(data=serv_opt,
                                  b_SomeOpt ~  cln_US6sal + 
                                    ...
                                    cln_OffObl7:cp_PairObl7+
                                    cp_OffPerf7:cln_Days+
                                    cn_PairHist7:PricingUCA, family=binomial(link="logit"))
...
```{r Model22A}
#Create the models
b_SomeOpt_CFTE_pricing_22A_no_interact <- glm(data=serv_opt, b_SomeOpt ~ PricingUCA + cln_PSCrate, 
                                             family=binomial(link="logit"))
glmer_examine(b_SomeOpt_CFTE_pricing_22A_no_interact)

b_SomeOpt_CFTE_pricing_22A <- glm(data=serv_opt, b_SomeOpt ~ PricingUCA + cln_PSCrate + PricingUCA:cln_PSCrate,
                                 family=binomial(link="logit"))
glmer_examine(b_SomeOpt_CFTE_pricing_22A)


b_AllOpt_CFTE_pricing_22A_no_interact <- glm(data=serv_exeropt, family=binomial(link="logit"), b_AllOpt ~ PricingUCA + cln_PSCrate)
glmer_examine(b_AllOpt_CFTE_pricing_22A_no_interact)

b_AllOpt_CFTE_pricing_22A <- glm(data=serv_exeropt, family=binomial(link="logit"), b_AllOpt ~ PricingUCA + cln_PSCrate + PricingUCA:cln_PSCrate)
...
b_SomeOpt_CFTE_pricing_22B <- glm(data=serv_opt,
                 ...
                 cp_OffPerf7:cln_Days+
                   ...
                   cn_PairHist7:PricingUCA+
                   clr_Ceil2Base:cln_Base+
                 PricingUCA:cln_PSCrate, family=binomial(link="logit"))
...
```
Some is not significant in line with expectation and raises the AIC slightly. Swapping to use of just PSCrate:PricingUCA increases AIC, more though is more in line with expectations. Leaving out, though swapping for model alignment has some appeal.
...
####26B: 2019-08-31 - Dropped cp_OffPSC7:cln_OffObl7 but added  cp_OffPerf7:cln_Days+
```{r SomeOpt26B}
...
```{r SomeOpt26C}
if(file.exists("..//Output//b_SomeOpt26C.rda"))  load("..//Output//b_SomeOpt26C.rda")
if(file.exists("..//Output//b_AllOpt26C.rda"))  load("..//Output//b_AllOpt26C.rda")

if(!exists("b_SomeOpt26C")){
...
stargazer::stargazer(b_AllOpt25A,b_AllOpt25B,b_AllOpt26A,b_AllOpt26C, type = "text", digits = 2)
...
####26C: 2019-12-29 - All_26A but for Some.
...
if(!exists("b_SomeOpt26A")){
  b_SomeOpt26C <- glmer(data=serv_opt,
                        b_SomeOpt ~  cln_US6sal + 
                   cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                 cn_PairHist7+#cln_PairCA+
                 cln_Base + clr_Ceil2Base + cln_Days+
      ...
      cln_OffFocus+
                 ...
                 # PricingUCA:cln_PSCrate+
                   cln_OffObl7:cln_OffFocus+
                          ...
                          family=binomial(link="logit"),
                          verbose=TRUE)
  save(b_SomeOpt26C, file="..\\Output\\b_SomeOpt26A.rda")
...
####27A: 2019-12-28 Trimmed down Some Options
...
if(!exists("b_AllOpt27A")){
  b_AllOpt27A <- glmer(data=serv_opt, b_SomeOpt ~  cln_US6sal +
                            cln_PSCrate+ cp_OffPerf7+cp_OffPSC7+
                            cn_PairHist7+cln_PairCA+
                            cln_Base + clr_Ceil2Base + cln_Days+
                            Comp+
                          ...
                          family=binomial(link="logit"),
                          verbose=TRUE)
  save(b_AllOpt27A, file="..\\Output\\b_AllOpt27A.rda")
}


glmer_examine(b_AllOpt27A)

stargazer::stargazer(b_SomeOpt_base2ceil_ceiling_21B,b_SomeOpt25A, b_SomeOpt25Cv3,b_SomeOpt26C,
                     b_SomeOpt27A, type = "text", digits = 2)

glmer_examine(b_AllOpt27A)


stargazer::stargazer(b_AllOpt25A,b_AllOpt25B,b_AllOpt26A,
                     b_AllOpt26C,b_AllOpt27A, type = "text", digits = 2)


summary_residual_compare(b_SomeOpt25A, b_SomeOpt27A,
                     b_SomeOpt25Cv2,b_SomeOpt27A, bins=100)
